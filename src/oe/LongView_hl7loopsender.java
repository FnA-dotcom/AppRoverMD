...
//                    hstmt2 = conn.createStatement();
                    Query = " SELECT id,msg,mrn,flag FROM request WHERE status=0 and ClientIndex = " + clientid + " and flag <= 3 limit 2";
...
//                        }
                        ...
                        final Thread reader = new Thread(client, "AppRover Client");
...
/*            Query = "update oe.request set msg = '" + msg + "' where id = '" + TraceId + "'";
            ...
            pushtologs("Exception (LongView) : " + ee.getMessage());
            pushtologs("Exception (LongView) : " + str);
            try {
/*                hstmt2 = conn.createStatement();
