...
public class LifeSaverER_hl7Looper implements Runnable {
    ...
    static {
        LifeSaverER_hl7Looper.SignonDone = false;
    }

    private Socket sock;
    private boolean done;

    public LifeSaverER_hl7Looper(final Socket socket) {
        this.done = false;
        this.sock = socket;
        TraceNo = 0;
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            final String Host = "172.20.28.204";
            clientid = "";
            clientdb = "";

            System.out.println("Initializing the application ..........");
            System.out.println("Connecting to EPD server Ver. " + version + " Dated 12 January 2022");
            ...
            while (true) {
                try {
                    ...
                    Query = " SELECT id,msg,mrn,flag,ClientIndex FROM request " +
                            "WHERE status=0 and ClientIndex in (41,42,43) " +
                            "and flag <= 3 limit 2";
                    ...
                    while (hrset.next()) {
                        ...
                        System.out.println("***** Facility IDx ***** => " + clientid);
                        ...
                        Thread.sleep(750L);
                        final LifeSaverER_hl7Looper client = new LifeSaverER_hl7Looper(sock);
...
/*                    AddressIfDifferent = rset.getString(7);
            ...
            pushtologs("Exception (LifeSaveER - " + clientdb + ") : " + ee.getMessage());
            pushtologs("Exception (LifeSaveER - " + clientdb + ") : " + str);
            try {
                PreparedStatement pStmt = null;
