...
public class Willowbrook_hl7Looper implements Runnable {
    ...
    static {
        Willowbrook_hl7Looper.SignonDone = false;
    }

    private Socket sock;
    private boolean done;

    public Willowbrook_hl7Looper(final Socket socket) {
        this.done = false;
        this.sock = socket;
        TraceNo = 0;
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            clientid = "41";
            clientdb = "willowbrook";

            System.out.println("Initializing the application ..........");
            System.out.println("Connecting to EPD server Ver. " + version + " Dated 8th January 2022");
            ...
            while (true) {
                try {
                    ...
                    while (rset.next()) {
                        ...
                        Thread.sleep(750L);
                        final Willowbrook_hl7Looper client = new Willowbrook_hl7Looper(sock);
    ...
    public static void sendmsg2(final Socket sock, String msg, final String mrn, final int flag, final Connection conn, String MSCID) {
        ...
        try {
            ...
            String MSH7 = MSCID;
            msg = "MSH|^~\\&||786|ADT|3344|" + MSH7 + "||ADT^" + Synctype + "|" + MSH7 + "|P|2.3\r\n"
            ...
            pushtologs("Exception (Willowbrook) : " + ee.getMessage());
            pushtologs("Exception (Willowbrook`) : " + str);
