...
//            final String Param9 = "";
            ...
            while (true) {
                try {
                    ...
                    Query = " SELECT id,msg,mrn,flag,ClientIndex FROM request WHERE status=0 and ClientIndex in (27,29) " +
                            "and flag <= 3 limit 2";
...
//            System.out.println(str);
            ...
            pushtologs("Exception (FrontLine - " + clientdb + ") : " + ee.getMessage());
            pushtologs("Exception (FrontLine - " + clientdb + ") : " + str);
            try {
/*                hstmt2 = conn.createStatement();
