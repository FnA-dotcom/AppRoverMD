...
public class Summerwood_hl7Looper implements Runnable {
    ...
    static {
        Summerwood_hl7Looper.SignonDone = false;
    }

    private Socket sock;
    private boolean done;

    public Summerwood_hl7Looper(final Socket socket) {
        this.done = false;
        this.sock = socket;
        TraceNo = 0;
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Connecting to EPD server Ver. " + version + " Dated 22nd December 2021");
            ...
            while (true) {
                try {
                    ...
                    while (rset.next()) {
                        ...
                        Thread.sleep(750L);
                        final Summerwood_hl7Looper client = new Summerwood_hl7Looper(sock);
    ...
    public static void sendmsg2(final Socket sock, String msg, final String mrn, final int flag, final Connection conn, String MSCID) {
        ...
        try {
            ...
            String MSH7 = MSCID;
            msg = "MSH|^~\\&||773|ADT|3344|" + MSH7 + "||ADT^" + Synctype + "|" + MSH7 + "|P|2.3\r\n"
            ...
            pushtologs("Exception (Summerwood) : " + ee.getMessage());
            pushtologs("Exception (Summerwood) : " + str);
