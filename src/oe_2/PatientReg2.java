...
//                Query = "SELECT MAX(MRN) + 1  FROM " + Database + ".PatientReg ";
            ...
            try {
                ...
                final PreparedStatement MainReceipt = conn.prepareStatement(" INSERT INTO " + Database + ".PatientReg (ClientIndex,FirstName,LastName ," +
                        ...
                        " PriCarePhy,ReasonVisit,SelfPayChk,CreatedDate,Title, MaritalStatus,CreatedBy, MRN, Status, ExtendedMRN) \n" +
                        " VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,now(),?,?,?,?,0,?) ");
            ...
            Parser.GenerateHtml(out, "/opt/Htmls/oe_2/Exception/Message.html");
