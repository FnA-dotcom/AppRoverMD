...
public class PatientReg2_21APRIL2021 extends HttpServlet {
...
//                    Testing(request, out, conn, context);
                    Victoria_2(request, out, conn, context);
                    break;
                case "Victoria_22":
            ...
            Parsehtm Parser = new Parsehtm(request);
            Parser.GenerateHtml(out, Services.GetHtmlPath(context) + "Exception/ErrorMaintenance.html");
            Services.DumException("PatientReg2", "handleRequest", request, e, context);
            out.flush();
            out.close();
        } finally {
            try {
    ...
    void Victoria_2(final HttpServletRequest request, final PrintWriter out, final Connection conn, final ServletContext servletContext) {
        try {
            ...
            Parser.GenerateHtml(out, (Services.GetHtmlPath(servletContext)) + "Forms/PatientRegFormVictoria_2.html");
        ...
        try {
            ...
            try {
                ...
                final PreparedStatement MainReceipt = conn.prepareStatement(" INSERT INTO " + Database + ".PatientReg (ClientIndex,FirstName,LastName ,"
                        ...
                        + " PriCarePhy,ReasonVisit,SelfPayChk,CreatedDate,Title, MaritalStatus,CreatedBy, MRN, Status, ExtendedMRN, County,sync) \n"
                        + " VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,now(),?,?,?,?,0,?,?,0) ");
            ...
            try {
                final PreparedStatement MainReceipt = conn.prepareStatement(
                        " INSERT INTO " + Database + ".PatientReg_Details (PatientRegId,Ethnicity," +
                                "Race,EmployementChk,Employer,Occupation,EmpContact,PrimaryCarePhysicianChk,PriCarePhy," +
                                "ReasonVisit,PriCarePhyAddress,PriCarePhyCity,PriCarePhyState,PriCarePhyZipCode," +
                                "PatientMinorChk,GuarantorChk,GuarantorEmployer,GuarantorEmployerPhNumber," +
                                "GuarantorEmployerAddress,GuarantorEmployerCity,GuarantorEmployerState," +
                                "GuarantorEmployerZipCode,CreatedDate,WorkersCompPolicyChk,MotorVehicleAccidentChk," +
                                "HealthInsuranceChk) \n" +
                                " VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,now(),?,?,?) ");
                ...
                try {
                    final PreparedStatement MainReceipt = conn.prepareStatement(
                            " INSERT INTO " + Database + ".Patient_WorkCompPolicy (PatientRegId,WCPDateofInjury," +
                                    ...
                                    "WCPInjuryRelatedWorkRelated,WCPInjuryRelatedOtherAccident," +
                                    "WCPInjuryRelatedNoAccident,WCPInjuryOccurVehicle,WCPInjuryOccurWork," +
                                    "WCPInjuryOccurHome,WCPInjuryOccurOther,WCPInjuryDescription," +
                ...
                try {
                    final PreparedStatement MainReceipt = conn.prepareStatement(
                            " INSERT INTO " + Database + ".Patient_AutoInsuranceInfo (PatientRegId," +
                                    "AutoInsuranceInformationChk,AIIDateofAccident,AIIAutoClaim,AIIAccidentLocationAddress," +
                                    "AIIAccidentLocationCity,AIIAccidentLocationState,AIIAccidentLocationZipCode," +
                                    "AIIRoleInAccident,AIITypeOfAutoIOnsurancePolicy,AIIPrefixforReponsibleParty," +
                                    "AIIFirstNameforReponsibleParty,AIIMiddleNameforReponsibleParty," +
                                    ...
                                    "AIICarrierResponsiblePartyZipCode,AIICarrierResponsiblePartyPhoneNumber," +
                                    "AIICarrierResponsiblePartyPolicyNumber,AIIResponsiblePartyAutoMakeModel," +
                ...
                try {
                    final PreparedStatement MainReceipt = conn.prepareStatement(
                            " INSERT INTO " + Database + ".Patient_HealthInsuranceInfo (PatientRegId," +
                                    "GovtFundedInsurancePlanChk,GFIPMedicare,GFIPMedicaid,GFIPCHIP,GFIPTricare,GFIPVHA," +
                                    "GFIPIndianHealth,InsuranceSubPatient,InsuranceSubGuarantor,InsuranceSubOther," +
                                    "HIPrimaryInsurance,HISubscriberFirstName,HISubscriberLastName,HISubscriberDOB," +
                                    "HISubscriberSSN,HISubscriberRelationtoPatient,HISubscriberGroupNo," +
                                    "HISubscriberPolicyNo,SecondHealthInsuranceChk,SHISecondaryName,SHISubscriberFirstName," +
                                    "SHISubscriberLastName,SHISubscriberRelationtoPatient,SHISubscriberGroupNo," +
...
//            Parser.GenerateHtml(out, "/sftpdrive/opt/Htmls/md/Exception/Message.html");
            //System.out.println(String.valueOf(String.valueOf(Services.GetHtmlPath(servletContext))));
        ...
        try {
            ...
            try {
                Query = "Update " + Database + ".PatientReg Set FirstName = '" + FirstName.toUpperCase() + "', " +
                        "LastName = '" + LastName.toUpperCase() + "', MiddleInitial = '" + MiddleInitial.toUpperCase() + "'," +
                        " DOB = '" + DOB + "', " + "Age = " + Age + ", Gender = '" + gender + "', Email = '" + Email + "'," +
                        " PhNumber = '" + AreaCode + PhNumber + "', Address = '" + Address + Address2 + "', " +
                        "City = '" + City.toUpperCase() + "', " + "State = '" + State.toUpperCase() + "', Country = '" + Country.toUpperCase() + "', " +
                        "ZipCode = '" + ZipCode + "',SSN = '" + SSN + "',Occupation = '" + Occupation + "', " +
                        "Employer = '" + Employer + "', " + "EmpContact = '" + EmpContact + "', " +
                        "PriCarePhy = '" + PriCarePhy + "',ReasonVisit = '" + ReasonVisit + "' , " +
                        "Title = '" + Title.toUpperCase() + "',MaritalStatus = '" + MaritalStatus.toUpperCase() + "', " +
                        " DoctorsName = '" + DoctorName + "' ,County = '" + County + "' where ID = " + PatientRegId;
...
//                out.println("Query2: "+Query);
            ...
            if (HealthInsuranceChk.equals("1")) {
                ...
                try {
                    if (HealthInsFound > 0) {
                        Query = "Update " + Database + ".Patient_HealthInsuranceInfo Set " +
                                "GovtFundedInsurancePlanChk = '" + GovtFundedInsurancePlanChk + "', " +
                                "GFIPMedicare = '" + GFIPMedicare + "', GFIPMedicaid = '" + GFIPMedicaid + "', " +
                                "GFIPCHIP = '" + GFIPCHIP + "', " + "GFIPTricare = '" + GFIPTricare + "', " +
                                "GFIPVHA = '" + GFIPVHA + "', GFIPIndianHealth = '" + GFIPIndianHealth + "', " +
                                "InsuranceSubPatient = '" + InsuranceSubPatient.toUpperCase() + "', " +
                                "InsuranceSubGuarantor = '" + InsuranceSubGuarantor.toUpperCase() + "', " +
                                "InsuranceSubOther = '" + InsuranceSubOther.toUpperCase() + "', HIPrimaryInsurance = '" + HIPrimaryInsurance.toUpperCase() + "', " +
                                ...
                                "SHISubscriberFirstName = '" + SHISubscriberFirstName.toUpperCase() + "', " + "SHISubscriberLastName = '" + SHISubscriberLastName.toUpperCase() + "' ," +
                                "SHISubscriberRelationtoPatient = '" + SHISubscriberRelationtoPatient.toUpperCase() + "', SHISubscriberGroupNo = '" + SHISubscriberGroupNo + "', " +
                                "SHISubscriberPolicyNo= '" + SHISubscriberPolicyNo + "' where PatientRegId = " + PatientRegId;
                        ...
                        try {
                            final PreparedStatement MainReceipt = conn.prepareStatement(
                                    " INSERT INTO " + Database + ".Patient_HealthInsuranceInfo (PatientRegId," +
                                            "GovtFundedInsurancePlanChk,GFIPMedicare,GFIPMedicaid,GFIPCHIP,GFIPTricare,GFIPVHA,GFIPIndianHealth,InsuranceSubPatient," + "InsuranceSubGuarantor,InsuranceSubOther,HIPrimaryInsurance,HISubscriberFirstName,HISubscriberLastName,HISubscriberDOB,HISubscriberSSN," + "HISubscriberRelationtoPatient,HISubscriberGroupNo,HISubscriberPolicyNo,SecondHealthInsuranceChk,SHISecondaryName," + "SHISubscriberFirstName,SHISubscriberLastName,SHISubscriberRelationtoPatient,SHISubscriberGroupNo,SHISubscriberPolicyNo,CreatedDate) \n" + " VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,now()) ");
                            MainReceipt.setInt(1, PatientRegId);
                            MainReceipt.setInt(2, Integer.parseInt(GovtFundedInsurancePlanChk));
                            MainReceipt.setInt(3, Integer.parseInt(GFIPMedicare));
                            MainReceipt.setInt(4, Integer.parseInt(GFIPMedicaid));
    ...
    private void CheckPatient(HttpServletRequest request, PrintWriter out, Connection conn) {
        String Query = "";
        Statement stmt = null;
        ResultSet rset = null;
        ...
        try {
            ...
            LastName = request.getParameter("LastName").trim();
            DOB = request.getParameter("DOB").trim();
            //DOB = String.valueOf(String.valueOf(DOB.substring(6, 9))) + "-" + DOB.substring(0, 2) + "-" + DOB.substring(3, 5);
    ...
    private String InsertCOVIDReg(final HttpServletRequest request, final HttpServletResponse response, final PrintWriter out, final Connection conn, final String PatientRegId) throws JsonProcessingException {
        ...
        String reply = "";
        try {
            Query = "Select IFNULL(FirstName,''), IFNULL(MiddleInitial,''), IFNULL(LastName,''), IFNULL(Email, ''), IFNULL(PhNumber,0), " +
                    " IFNULL(DOB,'0000-00-00'), IFNULL(Gender,'M'), IFNULL(City,''),IFNULL(Address,''), IFNULL(State,'TX'), IFNULL(ZipCode,''), IFNULL(County,'') " +
