...
public class SignPrint20OCT2021 extends HttpServlet {
...
//                out.println(imageURL[i]);
                try {
                    ...
                    String ImageTransparent = this.MakeTransparent(out, "/sftpdrive/AdmissionBundlePdf/SignImg/erDallas/img_" + i + "_" + PatientRegId + ".png", "/sftpdrive/AdmissionBundlePdf/SignImg/frontline/img_" + i + "_" + PatientRegId + ".png");
