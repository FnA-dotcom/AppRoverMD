...
public class PatientReg2_15JAN2021 extends HttpServlet {
    ...
    void Victoria_2(final HttpServletRequest request, final PrintWriter out, final Connection conn, final ServletContext servletContext) {
        try {
            ...
            Parser.GenerateHtml(out, String.valueOf(Services.GetHtmlPath(this.getServletContext())) + "Forms/PatientRegFormVictoria_2.html");
        } catch (Exception ex) {
        }
    }
    ...
    void Victoria_22(final HttpServletRequest request, final PrintWriter out, final Connection conn, final ServletContext servletContext) {
        try {
            ...
            Parser.SetField("ClientIndex", String.valueOf(ClientIndex));
            Parser.SetField("ProfessionalPayersList", String.valueOf(ProfessionalPayersList));
            Parser.GenerateHtml(out, String.valueOf(Services.GetHtmlPath(this.getServletContext())) + "Forms/PatientRegFormVictoria_22.html");
        } catch (Exception ex) {
        }
    }
    ...
    void SaveDataVictoria(final HttpServletRequest request, final PrintWriter out, final Connection conn, final ServletContext servletContext, final HttpServletResponse response) {
        try {
            ...
            if (request.getParameter("DOB") == null) {
                ...
                DOB = String.valueOf(DOB.substring(6, 10)) + "-" + DOB.substring(0, 2) + "-" + DOB.substring(3, 5);
            }
            ...
            if (WorkersCompPolicyChk.equals("1")) {
                if (request.getParameter("WCPDateofInjury") == null) {
                    ...
                    WCPDateofInjury = String.valueOf(WCPDateofInjury.substring(6, 10)) + "-" + WCPDateofInjury.substring(0, 2) + "-" + WCPDateofInjury.substring(3, 5);
                }
            ...
            if (MotorVehicleAccidentChk.equals("1")) {
                ...
                if (AutoInsuranceInformationChk.equals("1")) {
                    if (request.getParameter("AIIDateofAccident") == null) {
                        ...
                        AIIDateofAccident = String.valueOf(AIIDateofAccident.substring(6, 10)) + "-" + AIIDateofAccident.substring(0, 2) + "-" + AIIDateofAccident.substring(3, 5);
                    }
            ...
            if (HealthInsuranceChk.equals("1")) {
                ...
                if (request.getParameter("HISubscriberDOB") == null) {
                    ...
                    HISubscriberDOB = String.valueOf(HISubscriberDOB.substring(6, 10)) + "-" + HISubscriberDOB.substring(0, 2) + "-" + HISubscriberDOB.substring(3, 5);
                }
                ...
                if (SecondHealthInsuranceChk.equals("1")) {
                    ...
                    if (request.getParameter("SHISubscriberDOB") == null) {
                        ...
                        SHISubscriberDOB = String.valueOf(SHISubscriberDOB.substring(6, 10)) + "-" + SHISubscriberDOB.substring(0, 2) + "-" + SHISubscriberDOB.substring(3, 5);
                    }
            ...
            try {
                ...
                MainReceipt.setString(9, String.valueOf(AreaCode) + PhNumber);
                MainReceipt.setString(10, String.valueOf(Address) + " " + Address2);
                ...
                Services.DumException("PatientReg2", "SaveDataVictoria" + "Error 2- Insertion PatientReg Table :", request, e, getServletContext());
//                out.println("Error 2- Insertion PatientReg Table :" + e.getMessage());
            ...
            try {
                ...
                Services.DumException("PatientReg2", "SaveDataVictoria" + "Error 3- :", request, e, getServletContext());
//                out.println("Error 3- :" + e.getMessage());
            ...
            try {
                ...
                Services.DumException("PatientReg2", "SaveDataVictoria" + "Error 3.1 Insertion in table PatientVisit- :", request, e, getServletContext());
//                out.println("Error 3.1 Insertion in table PatientVisit- :" + e.getMessage());
            ...
            try {
                ...
                MainReceipt.setString(11, String.valueOf(PriCarePhyAddress) + " " + PriCarePhyAddress2);
                ...
                MainReceipt.setString(18, String.valueOf(GuarantorEmployerAreaCode) + GuarantorEmployerPhNumber);
                MainReceipt.setString(19, String.valueOf(GuarantorEmployerAddress) + " " + GuarantorEmployerAddress2);
                ...
                Services.DumException("PatientReg2", "SaveDataVictoria" + "Error 4- Insertion PatientReg_Details Table :", request, e, getServletContext());
//                out.println("Error 4- Insertion PatientReg_Details Table :" + e.getMessage());
            ...
            if (WorkersCompPolicyChk.equals("1")) {
                try {
                    ...
                    MainReceipt.setString(17, String.valueOf(WCPHRAreaCode) + WCPHRPhoneNumber);
                    MainReceipt.setString(18, String.valueOf(WCPHRAddress) + " " + WCPHRAddress2);
                    ...
                    MainReceipt.setString(24, String.valueOf(WCPPayerAreaCode) + WCPPayerPhoneNumber);
                    MainReceipt.setString(25, String.valueOf(WCPCarrierAddress) + " " + WCPCarrierAddress2);
                    ...
                    MainReceipt.setString(31, String.valueOf(WCPAdjudicatorAreaCode) + WCPAdjudicatorPhoneNumber);
                    MainReceipt.setString(32, String.valueOf(WCPAdjudicatorFaxAreaCode) + WCPAdjudicatorFaxPhoneNumber);
                    MainReceipt.executeUpdate();
                    MainReceipt.close();
                } catch (Exception e) {
                    Services.DumException("PatientReg2", "SaveDataVictoria" + "Error 5- Insertion Patient_WorkCompPolicy Table :", request, e, getServletContext());
            ...
            if (MotorVehicleAccidentChk.equals("1")) {
                try {
                    ...
                    MainReceipt.setString(5, String.valueOf(AIIAccidentLocationAddress) + " " + AIIAccidentLocationAddress2);
                    ...
                    MainReceipt.setString(17, String.valueOf(AIICarrierResponsiblePartyAddress) + " " + AIICarrierResponsiblePartyAddress2);
                    ...
                    MainReceipt.setString(21, String.valueOf(AIICarrierResponsiblePartyAreaCode) + AIICarrierResponsiblePartyPhoneNumber);
                    ...
                    MainReceipt.setString(28, String.valueOf(AIIYourInsuranceAddress) + " " + AIIYourInsuranceAddress2);
                    ...
                    MainReceipt.setString(32, String.valueOf(AIIYourInsuranceAreaCode) + AIIYourInsurancePhoneNumber);
                    ...
                    Services.DumException("PatientReg2", "SaveDataVictoria" + "Error 6- Insertion Patient_AutoInsuranceInfo Table :", request, e, getServletContext());
            ...
            if (HealthInsuranceChk.equals("1")) {
                try {
                    ...
                    Services.DumException("PatientReg2", "SaveDataVictoria" + "Error 7- Insertion Patient_HealthInsuranceInfo Table", request, e, getServletContext());
                    //out.println("Error 7- Insertion Patient_HealthInsuranceInfo Table :" + e.getMessage());
//                    String str = "";
//                    for (int i = 0; i < e.getStackTrace().length; ++i) {
//                        str = String.valueOf(str) + e.getStackTrace()[i] + "<br>";
//                    }
                    //out.println(str);
                    return;
                }
            ...
            System.out.println(String.valueOf(ReasonVisit) + " Before");
            if (ReasonVisit != null) {
                ReasonVisit = ReasonVisit.replaceAll(" ", "");
                System.out.println(String.valueOf(ReasonVisit) + " After");
            ...
            Services.DumException("PatientReg2", "SaveDataVictoria", request, e2, getServletContext());
        ...
        try {
            ...
            if (PrimaryCarePhysicianChk.equals("1")) {
                PriCarPhyBuffer.append("<div class=\"controls\">\n"
                        ...
                        + "</div>\n"
                        + "");
                Style = String.valueOf(Style) + " #PrimaryCarePhysicianDiv{ display: block; }";
                ...
                PriCarPhyBuffer.append("<div class=\"controls\">\n"
                        ...
                        + "</div>\n"
                        + "");
                Style = String.valueOf(Style) + " #PrimaryCarePhysicianDiv{ display: none; }";
            } else {
                PriCarPhyBuffer.append("<div class=\"controls\">\n"
                        + "<fieldset>\n"
                        + "<input name=\"PrimaryCarePhysicianChk\" type=\"radio\" id=\"PrimaryCarePhysicianChk_Yes\" value=\"1\" onclick=\"PrimaryCarePhysicianDivShow(this.value)\"   />\n"
            ...
            if (WorkersCompPolicyChk.equals("1")) {
                WorkCompBuffer.append("<div class=\"controls\">\n"
                        ...
                        + "</div>\n"
                        + "");
                Style = String.valueOf(Style) + " #WorkersCompPolicyDiv{ display: block; }";
            } else {
                WorkCompBuffer.append("<div class=\"controls\">\n"
                        + "<fieldset>\n"
                        ...
                        + "</div>\n"
                        + "");
                Style = String.valueOf(Style) + " #WorkersCompPolicyDiv{ display: none; }";
            }
            ...
            if (MotorVehicleAccidentChk.equals("1")) {
                MotorVehicleBuffer.append("<div class=\"controls\">\n"
                        ...
                        + "</div>\n"
                        + "");
                Style = String.valueOf(Style) + " #MotorVehicleAccidentDiv{ display: block; }";
            } else {
                MotorVehicleBuffer.append("<div class=\"controls\">\n"
                        + "<fieldset>\n"
                        ...
                        + "</div>\n"
                        + "");
                Style = String.valueOf(Style) + " #MotorVehicleAccidentDiv{ display: none; }";
            }
            if (AutoInsuranceInformationChk.equals("1")) {
                AutoInsuranceBuffer.append("<div class=\"controls\">\n"
                        ...
                        + "</div>\n"
                        + "");
                Style = String.valueOf(Style) + " #AutoInsuranceInformationDiv1{ display: block; } #AutoInsuranceInformationDiv2{ display: block; }";
                ...
                AutoInsuranceBuffer.append("<div class=\"controls\">\n"
                        ...
                        + "</div>\n"
                        + "");
                Style = String.valueOf(Style) + " #AutoInsuranceInformationDiv1{ display: none; } #AutoInsuranceInformationDiv2{ display: block; } ";
            } else {
                AutoInsuranceBuffer.append("<div class=\"controls\">\n"
                        + "<fieldset>\n"
                        + "<input name=\"AutoInsuranceInformationChk\" type=\"radio\" id=\"AutoInsuranceInformationChk_Yes\" value=\"1\"  onclick=\"AutoInsuranceInformationDivShow(this.value)\"/>\n"
                        ...
                        + "</div>\n"
                        + "");
                Style = String.valueOf(Style) + " #AutoInsuranceInformationDiv1{ display: none;} #AutoInsuranceInformationDiv2{ display: none; } ";
            }
            ...
            if (HealthInsuranceChk.equals("1")) {
                HealthInsuranceBuffer.append("<div class=\"controls\">\n"
                        ...
                        + "</div>\n"
                        + "");
                Style = String.valueOf(Style) + " #HealthInsuranceDiv{ display: block; }";
            } else {
                HealthInsuranceBuffer.append("<div class=\"controls\">\n"
                        + "<fieldset>\n"
                        ...
                        + "</div>\n"
                        + "");
                Style = String.valueOf(Style) + " #HealthInsuranceDiv{ display: none; }";
            }
            if (GovtFundedInsurancePlanChk.equals("1")) {
                GovtFundedInsuranceBuffer.append("<div class=\"demo-radio-button\">\n"
                        ...
                        + "</div>									 \n"
                        + "");
                Style = String.valueOf(Style) + " #GovtFundedInsurancePlanDiv{ display: block; }";
            } else {
                GovtFundedInsuranceBuffer.append("<div class=\"demo-radio-button\">\n"
                        ...
                        + "</div>									 \n"
                        + "");
                Style = String.valueOf(Style) + " #GovtFundedInsurancePlanDiv{ display: none; }";
            }
            ...
            if (SecondHealthInsuranceChk.equals("1")) {
                SecondHealthInsuranceBuffer.append("<div class=\"demo-radio-button\">\n"
                        ...
                        + "</div>");
                Style = String.valueOf(Style) + " #SecondHealthInsuranceDiv{ display: block; }";
                ...
                SecondHealthInsuranceBuffer.append("<div class=\"demo-radio-button\">\n"
                        ...
                        + "<label for=\"SecondHealthInsuranceChk_No\">No</label>	\n"
                        + "</div>");
                Style = String.valueOf(Style) + " #SecondHealthInsuranceDiv{ display: none; }";
            } else {
                SecondHealthInsuranceBuffer.append("<div class=\"demo-radio-button\">\n"
                        + "<input name=\"SecondHealthInsuranceChk\" type=\"radio\" id=\"SecondHealthInsuranceChk_Yes\" value=\"1\"  onclick=\"SecondHealthInsuranceDivShow(this.value)\"/>\n"
                        + "<label for=\"SecondHealthInsuranceChk_Yes\">Yes</label>\n"
...
//            Query = "Select Title from "+Database+".Title";
            Query = "Select Value, PriInsurance from " + Database + ".Master_PriIns where Status = 1";// where Id = "+HIPrimaryInsurance;
            stmt = conn.createStatement();
            rset = stmt.executeQuery(Query);
            ...
            Parser.SetField("SHISubscriberDOB", String.valueOf(SHISubscriberDOB));
            ...
            Services.DumException("PatientReg2", "EditValues", request, e2, getServletContext());
    ...
    void EditSave(final HttpServletRequest request, final PrintWriter out, final Connection conn, final ServletContext servletContext, final HttpServletResponse response) {
        try {
            ...
            try {
                ...
                Services.DumException("PatientReg2", "EditValue" + "Error in request getParameter", request, e, getServletContext());
...
//                out.println(str);
            ...
            try {
                ...
                Services.DumException("PatientReg2", "EditValue" + "Error in updateing Patinet Reg INformation :", request, e, getServletContext());
//                out.println("Error in updateing Patinet Reg INformation : " + e.getMessage());
            }
            try {
                ...
                Services.DumException("PatientReg2", "EditValue" + "Error in updateing Patinet Reg Details tables:", request, e, getServletContext());
//                out.println("Error in updateing Patinet Reg Details tables: " + e.getMessage());
            }
            ...
            if (WorkersCompPolicyChk.equals("1")) {
                try {
                    ...
                    Services.DumException("PatientReg2", "EditValue" + "Error in Getting Count from  Patient_WorkCompPolicy tables: ", request, e, getServletContext());
                }
                try {
                    if (WorkCompFound > 0) {
                        ...
                        try {
                            PreparedStatement MainReceipt = conn.prepareStatement(" INSERT INTO " + Database + ".Patient_WorkCompPolicy (PatientRegId,WCPDateofInjury," + "WCPCaseNo,WCPGroupNo,WCPMemberId,WCPInjuryRelatedAutoMotorAccident,WCPInjuryRelatedWorkRelated,WCPInjuryRelatedOtherAccident," + "WCPInjuryRelatedNoAccident,WCPInjuryOccurVehicle,WCPInjuryOccurWork,WCPInjuryOccurHome,WCPInjuryOccurOther,WCPInjuryDescription," + "WCPHRFirstName,WCPHRLastName,WCPHRPhoneNumber,WCPHRAddress,WCPHRCity,WCPHRState,WCPHRZipCode,WCPPlanName,WCPCarrierName," + "WCPPayerPhoneNumber,WCPCarrierAddress,WCPCarrierCity,WCPCarrierState,WCPCarrierZipCode,WCPAdjudicatorFirstName,WCPAdjudicatorLastName," + "WCPAdjudicatorPhoneNumber,WCPAdjudicatorFaxPhoneNumber,CreatedDate) \n" + " VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,now()) ");
                            MainReceipt.setInt(1, PatientRegId);
                            MainReceipt.setString(2, WCPDateofInjury);
                            MainReceipt.setString(3, WCPCaseNo);
                            MainReceipt.setString(4, WCPGroupNo);
                    ...
                    Services.DumException("PatientReg2", "EditValue" + "Error in updateing/Inserting Patinet Reg WOrkCompPOlicy tables: ", request, e, getServletContext());
//                    out.println("Error in updateing Patinet Reg WOrkCompPOlicy tables: " + e.getMessage());
                }
            }
            if (MotorVehicleAccidentChk.equals("1")) {
                //out.println(AIIDateofAccident);
                try {
                    ...
                    Services.DumException("PatientReg2", "EditValue" + "Error in Getting Count from  Patient_AutoInsuranceInfo tables: ", request, e, getServletContext());
                }
                try {
                    if (MotorVehFound > 0) {
                        ...
                        try {
                            PreparedStatement MainReceipt = conn.prepareStatement(" INSERT INTO " + Database + ".Patient_AutoInsuranceInfo (PatientRegId," + "AutoInsuranceInformationChk,AIIDateofAccident,AIIAutoClaim,AIIAccidentLocationAddress,AIIAccidentLocationCity,AIIAccidentLocationState," + "AIIAccidentLocationZipCode,AIIRoleInAccident,AIITypeOfAutoIOnsurancePolicy,AIIPrefixforReponsibleParty,AIIFirstNameforReponsibleParty," + "AIIMiddleNameforReponsibleParty,AIILastNameforReponsibleParty,AIISuffixforReponsibleParty,AIICarrierResponsibleParty," + "AIICarrierResponsiblePartyAddress,AIICarrierResponsiblePartyCity,AIICarrierResponsiblePartyState,AIICarrierResponsiblePartyZipCode," + "AIICarrierResponsiblePartyPhoneNumber,AIICarrierResponsiblePartyPolicyNumber,AIIResponsiblePartyAutoMakeModel," + "AIIResponsiblePartyLicensePlate,AIIFirstNameOfYourPolicyHolder,AIILastNameOfYourPolicyHolder,AIINameAutoInsuranceOfYourVehicle," + "AIIYourInsuranceAddress,AIIYourInsuranceCity,AIIYourInsuranceState,AIIYourInsuranceZipCode,AIIYourInsurancePhoneNumber," + "AIIYourInsurancePolicyNo,AIIYourLicensePlate,AIIYourCarMakeModelYear,CreatedDate) \n" + " VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,now()) ");
                            MainReceipt.setInt(1, PatientRegId);
                            MainReceipt.setInt(2, Integer.parseInt(AutoInsuranceInformationChk));
                            MainReceipt.setString(3, AIIDateofAccident);
                            MainReceipt.setString(4, AIIAutoClaim);
                    ...
                    Services.DumException("PatientReg2", "EditValue" + " Error in updateing Patinet Reg AUtoInsuranceInfo tables: ", request, e, getServletContext());
//                    out.println("Error in updateing Patinet Reg AUtoInsuranceInfo tables: " + e.getMessage());
                }
            }
            if (HealthInsuranceChk.equals("1")) {
                try {
                ...
                try {
                    ...
                    Services.DumException("PatientReg2", "EditValue" + " Error in updateing Patinet Reg HealthInsuranceInfo tables: ", request, e, getServletContext());
//                    out.println("Error in updateing Patinet Reg AUtoInsuranceInfo tables: " + e.getMessage());
                }
            }
            final Parsehtm Parser = new Parsehtm(request);
            ...
            Parser.GenerateHtml(out, String.valueOf(Services.GetHtmlPath(servletContext)) + "Exception/Success.html");
        } catch (Exception e2) {
            Services.DumException("PatientReg2", "EditValue", request, e2, getServletContext());
//            out.println(e2.getMessage());
//            String str2 = "";
//            for (int j = 0; j < e2.getStackTrace().length; ++j) {
//                str2 = String.valueOf(str2) + e2.getStackTrace()[j] + "<br>";
//            }
//            out.println(str2);
        }
    }
    ...
    private String InsertCOVIDReg(final HttpServletRequest request, final HttpServletResponse response, final PrintWriter out, final Connection conn, final String PatientRegId) throws JsonProcessingException {
        ...
        try {
            ...
            Services.DumException("PatientReg2", "InsertCOVIDReg" + "Error in Getting Data from PatientReg table", request, e, getServletContext());
...
//            System.out.println("Message" + Message);
            Services.DumException("PatientReg2", "InsertCOVIDReg" + " " + Message, request, e, getServletContext());
            return Message;
        }
        return reply;
    }
