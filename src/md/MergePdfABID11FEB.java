...
public class MergePdfABID11FEB extends HttpServlet {
    ...
    public void GETINPUT(final HttpServletRequest request, final HttpServletResponse response, final PrintWriter out, final Connection conn, final String Database, final String Path1, final String Path2) {
        try {
