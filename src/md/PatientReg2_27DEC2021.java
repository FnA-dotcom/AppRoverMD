...
//            }
            ...
            return pdfReader3.getNumberOfPages() + "~" + outputFilePath + "~" + filename;//FirstNameNoSpaces + "_" + ID + "_" + DateTime + ".pdf";
        } catch (Exception e) {
            System.out.println(e.getMessage());
        }
        return "";
...
//            Part filePart = request.getPart("Idfront");
//            System.out.println("Inside |Try| filePart ->> "+filePart);
//
//            String fileName = filePart.getSubmittedFileName();
//            System.out.println("fileName ->> "+fileName);
//            for (Part part : request.getParts()) {
//                System.out.println("writing ");
//                part.write("/sftpdrive/AdmissionBundlePdf/Attachment/Victoria/Uploads/test/" + fileName);
//            }
//        } catch (IOException e2) {
////            e.printStackTrace();
//            System.out.println(" IOException ERROR ->>> "+ e2.getMessage());
//            String str = "";
//            for (int i = 0; i < (e2.getStackTrace()).length; i++)
//                str = str + e2.getStackTrace()[i] + "<br>";
