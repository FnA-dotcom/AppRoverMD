...
public class PatientRegValidation extends HttpServlet {
...
//            Parser.GenerateHtml(out, Services.GetHtmlPath(getServletContext()) + "Forms/PRF_files/" + PRF_name);
            Parser.GenerateHtml(out, Services.GetHtmlPath(getServletContext()) + "Forms/PRF_files_Test/PRFVal.html");
        } catch (Exception ex) {
    ...
    void SaveData(HttpServletRequest request, PrintWriter out, Connection conn, ServletContext servletContext, String Database, String UserId, UtilityHelper helper) throws FileNotFoundException {
        ...
        try {
            try {
                ...
                FirstName = getStringParameter(request, "FirstName", "");
                LastName = getStringParameter(request, "LastName", "");
                MiddleInitial = getStringParameter(request, "MiddleInitial", "");
                MaritalStatus = getStringParameter(request, "MaritalStatus", "");
                DOB = getStringParameter(request, "DOB", "0000-00-00");
    ...
    void EditValues_New(HttpServletRequest request, PrintWriter out, Connection conn, ServletContext servletContext, String Database, String UserId, UtilityHelper helper) throws FileNotFoundException {
        ...
        try {
            ...
            if (ReasonVisit.trim().toUpperCase().equals("ANTIBODY TEST") || ReasonVisit.trim().toUpperCase().equals("RAPID ANTIGEN TEST") || ReasonVisit.trim().toUpperCase().equals("COVID PCR") || ReasonVisit.trim().toUpperCase().equals("COVID TESTING") || ReasonVisit.trim().toUpperCase().equals("COVID VACCINE")) {
...
/*                    Query = "Update " + Database + ".RandomCheckInfo set ReturnPatient = " + ReturnPatient + ", Google = " + Google + ", " +
    ...
    private String getStringParameter(HttpServletRequest request, String name, String defaultVal) {
    ...
    private String getNumParameter(HttpServletRequest request, String name, String defaultVal) {
        String val = request.getParameter(name);
