...
public class PatientReg_MobileNEW24FEB2021 extends HttpServlet {
    ...
    public void handleRequest(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (ActionID.equals("GetValues")) {
                ...
                this.EditSave(request, out, conn, context, DatabaseName);
            }
        } catch (Exception ee) {
...
//     int ClientIndex = 0;
        ...
        String SympAbdPain = "0";
        String SympRash = "0";
        String SympVomiting = "0";
        String SympDiarrhea = "0";
        String SympCough = "0";
        String SympEyePain = "0";
        String SympEyeIrritation = "0";
        String SympEyeDrainage = "0";
...
//             DOB =  DOB.substring(6,10) + "-" + DOB.substring(0,2) + "-" + DOB.substring(3,5);
            ...
            if (request.getParameter("SympAbdPain") == null) {
                SympAbdPain = "0";
            } else {
                SympAbdPain = "1";
            }
            ...
            if (request.getParameter("SympEyePain") == null) {
                SympEyePain = "0";
            } else {
                SympEyePain = "1";
            }
            if (request.getParameter("SympEyeIrritation") == null) {
                SympEyeIrritation = "0";
            } else {
                SympEyeIrritation = "1";
            }
            if (request.getParameter("SympEyeDrainage") == null) {
                SympEyeDrainage = "0";
            } else {
                SympEyeDrainage = "1";
            }
            ...
            try {
                final PreparedStatement MainReceipt = conn.prepareStatement(
                        "INSERT INTO " + Database + ".PatientReg_Details (PatientRegId,MRN,TravellingChk,TravelWhen,TravelWhere ,TravelHowLong,COVIDExposedChk, " +
                                " SympFever,SympBodyAches ,SympSoreThroat,SympAbdPain ," +
                                " SympRash,SympVomiting ,SympDiarrhea,SympCough,SympEyePain,SympEyeIrritation,SympEyeDrainage ,SympEyeConjunctivitis, Race) " +
                                "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ");
                ...
                MainReceipt.setString(11, SympAbdPain);
                ...
                MainReceipt.setString(16, SympEyePain);
                MainReceipt.setString(17, SympEyeIrritation);
                MainReceipt.setString(18, SympEyeDrainage);
                MainReceipt.setString(19, SympEyeConjunctivitis);
