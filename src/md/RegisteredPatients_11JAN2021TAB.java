...
public class RegisteredPatients_11JAN2021TAB extends HttpServlet {
    static String DOS = "";
    static String Acct = "";
...
//        File dest = new File(String.valueOf( "/opt/"+FileName));
            ...
            final Parsehtm Parser = new Parsehtm(request);
            Parser.SetField("Message_fileUpload", String.valueOf("File Has been Uploaded Succesfully" + Message));
    ...
    private void InvoicePdf(final HttpServletRequest request, final HttpServletResponse response, final PrintWriter out, final Connection conn, final String UserId, final String Database, final int ClientId) {
        ...
        try {
            ...
            if (hostname.trim().equals("romver-01")) {
                ...
                logoImagePath = "/sftpdrive";
            }
            if (Database.equals("oe_2")) {
                jpeg = Image.getInstance(logoImagePath + "/opt/apache-tomcat-7.0.65/webapps/orange/images/logorange.jpg");
            } else if (Database.equals("victoria")) {
                jpeg = Image.getInstance(logoImagePath + "/opt/apache-tomcat-7.0.65/webapps/orange/images/logVictoria.jpg");
            } else if (Database.equals("oddesa")) {
                jpeg = Image.getInstance(logoImagePath + "/opt/apache-tomcat-7.0.65/webapps/orange/images/logOddesa.jpg");
            } else if (Database.equals("s_austin")) {
                System.out.println("Inside South Austin");
                jpeg = Image.getInstance(logoImagePath + "/opt/apache-tomcat-7.0.65/webapps/orange/images/logSAustin.jpg");
            }
            if (jpeg != null) {
                jpeg.setAlignment(3);
