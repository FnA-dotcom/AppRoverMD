...
//                    newStr = newStr.replaceAll("inforeceiver", "Provider");
    ...
    public static void parmsg(String msg2, String patientId, int clientId) {
...
//                    System.out.println("ResultMessage " + doc.getElementsByTagName("SuccessCode").item(0).getTextContent());
...
//                    System.out.println("----------------------------");
//                    System.out.println("----------------------------");
                    ResultMessage = doc.getElementsByTagName("SuccessCode").item(0).getTextContent();
...
/*                                    style.append("<head><style>table {  font-family: arial, sans-serif;  border-collapse: collapse;  width: 100%;} ");
                                    style.append("td, th {  border: 1px solid #dddddd;  text-align: left;  padding: 8px;}");
                                    style.append(" tr:nth-child(even) {  background-color: #dddddd;}</style></head>");*/
                            style.append("<head> <meta charset=\"UTF-8\"> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"> ");
                            style.append("<link href=\"/oe/bootstrap/css/bootstrap.min.css\" rel=\"stylesheet\" type=\"text/css\"/>");
                            style.append("<link href=\"https://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css\" rel=\"stylesheet\" type=\"text/css\"/>");
                            style.append("<link href=\"https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css\" rel=\"stylesheet\" type=\"text/css\"/>");
                            style.append("<link href=\"/oe/dist/css/AdminLTE.min.css\" rel=\"stylesheet\" type=\"text/css\"/>");
                            style.append("<link href=\"/oe/dist/css/skins/_all-skins.min.css\" rel=\"stylesheet\" type=\"text/css\"/>");
                            style.append("<link href=\"/oe/dist/css/AdminLTE.min.css\" rel=\"stylesheet\" type=\"text/css\"/>");
                            style.append("<link href=\"/oe/dist/css/sweetalert/sweetalert.css\" rel=\"stylesheet\">");
                            style.append(" <style> .sweet-overlay, .sweet-alert { position: absolute !important; } </style>");
                            style.append("</head>");

                            StringBuilder script = new StringBuilder();
                            script.append("<script src=\"/oe/plugins/jQuery/jQuery-2.1.4.min.js\" type=\"text/javascript\"></script>");
                            script.append("<script src=\"/oe/bootstrap/js/bootstrap.min.js\" type=\"text/javascript\"></script>");
                            script.append("<script src=\"/oe/plugins/fastclick/fastclick.min.js\" type=\"text/javascript\"></script>");
                            script.append("<script src=\"/oe/dist/js/app.min.js\" type=\"text/javascript\"></script>");
                            script.append("<script src=\"/oe/dist/js/demo.js\" type=\"text/javascript\"></script>");
                            script.append("<script src=\"/oe/dist/js/sweetalert/sweetalert.min.js\"></script>");
                            script.append("<script>");
                            script.append("$(document).ready(function () {");
                            script.append("swal({");
                            script.append("title: \"Error\",");
                            script.append("text: \"Error!, Something Went Wrong. Currently, Trizetto is experiencing some technical issues.\",");
                            script.append("showCancelButton: false,");
                            script.append("confirmButtonColor: \"#800000\",");
                            script.append("confirmButtonText: \"OK\",");
                            script.append("closeOnConfirm: true },");
                            script.append("function () { location.href = \"/md/md.EligibilityInquiry_3?ActionID=EligibilityGetInput&PatientId=" + patientId + "&ClientId=" + clientId + "\";");
                            script.append("});");
                            script.append("});");
                            script.append("</script>");

                            StringBuilder HtmlBody = new StringBuilder();
                            HtmlBody.append("<div class=\"content-wrapper\" style=\"margin-left:0px\">");
                            HtmlBody.append("<section class=\"content\">");
                            HtmlBody.append("<div class=\"row\">");
                            HtmlBody.append("<div class=\"col-md-6\">");
                            HtmlBody.append("<form style=\"background-color:#ECF0F5\">");
                            HtmlBody.append("<div id=\"test\">");
                            HtmlBody.append("<table>");
                            HtmlBody.append("<tr>");
                            HtmlBody.append("<td style=\"height:300px;\"></td>");
                            HtmlBody.append("</tr>");
                            HtmlBody.append("</table>");
                            HtmlBody.append("</div>");
                            ...
                            HtmlBody.append("</div>");
                            HtmlBody.append("</div>");
                            HtmlBody.append("</section>");
                            HtmlBody.append("</div>");

                            finaloutput.append("<html>" + style.toString() + "<body class=\"skin-blue sidebar-mini\">" + HtmlBody + " " + script + " </body></html>");
                            return;
                        }
                        Element line = (Element) title.item(0);
//                        System.out.println("Title: " + getCharacterDataFromElement(line));
...
//                    System.out.println("----------------------------");
                    ...
                    for (int i = 0; i < list2.getLength(); i++) {
                        ...
                        if (nNode2.getNodeType() == 1) {
                            ...
                            NodeList gender = eElement.getElementsByTagName("sex");
...
//                                System.out.println(" IN IF *********** ");
                            ...
                            NodeList date_of_birth = eElement.getElementsByTagName("date-of-birth");
                            if (date_of_birth.getLength() > 0) {
                                patientname.append("<tr class=\"Inner\">\n");
                                patientname.append("<td align=left>" + eElement.getElementsByTagName("date-of-birth").item(0).getNodeName() + "</td>\n");
                                patientname.append("<td align=left>" + eElement.getElementsByTagName("date-of-birth").item(0).getTextContent() + "</td>\n");
                                patientname.append("</tr>\n");
...
//                    System.out.println("IN INNER ELSE ******");
                    if (doc.getElementsByTagName("ExtraProcessingInfo").item(0).getTextContent().length() >= 1) {
                        NodeList myList = doc.getElementsByTagName("DoInquiryResult");
                        for (int i = 0; i < myList.getLength(); i++) {
                            Node nNode2 = myList.item(i);
                            if (nNode2.getNodeType() == 1) {
                                Element eElement = (Element) nNode2;

                                NodeList ExtraProcessingInfo = eElement.getElementsByTagName("ExtraProcessingInfo");
                                if (ExtraProcessingInfo.getLength() > 0) {
                                    System.out.println("----------------------------");
                                    ResultMessage = doc.getElementsByTagName("SuccessCode").item(0).getTextContent();
//                                    System.out.println("ResultMessage " + ResultMessage);
//                                    System.out.println("----------------------------");
...
/*                                    System.out.println();
                                    System.out.println("******************************");
                                    System.out.println(" AllMessages TAG " + eElement.getElementsByTagName("AllMessages").item(0).getNodeName());
                                    System.out.println(" AllMessages VAL " + eElement.getElementsByTagName("AllMessages").item(0).getTextContent());
                                    System.out.println("******************************");
                                    System.out.println();*/
                                    Error = 1;
                                    StringBuilder style = new StringBuilder();
...
/*                                    style.append("<head><style>table {  font-family: arial, sans-serif;  border-collapse: collapse;  width: 100%;} ");
                                    ...
                                    script.append("swal({");
                                    script.append("title: \"Error\",");
                                    script.append("text: \"Error!, Something Went Wrong. " + eElement.getElementsByTagName("AllMessages").item(0).getTextContent() + "   \",");
                                    script.append("showCancelButton: false,");
                                    script.append("confirmButtonColor: \"#800000\",");
                                    script.append("confirmButtonText: \"OK\",");
                                    script.append("closeOnConfirm: true },");
                                    ...
                                    finaloutput.append("<html>" + style.toString() + "<body class=\"skin-blue sidebar-mini\">" + HtmlBody + " " + script + " </body></html>");
                                    //Was trying to fetch further details but its of no use
                                    //Reason: Tags are not fixed they are variant. Unable to capture data
/*                                    System.out.println();
                                    System.out.println("******************************");
                                    System.out.println(" Failures TAG " + eElement.getElementsByTagName("Failures").item(0).getNodeName());
                                    System.out.println(" Failures VAL " + eElement.getElementsByTagName("Failures").item(0).getTextContent());
                                    System.out.println("******************************");
                                    System.out.println();
                                    visitChildNotesExtraProcessingInfo(ExtraProcessingInfo);*/
                                    //Error
/*                                    patientname.append((doc.getElementsByTagName("SuccessCode").item(0).getTextContent()));
                                    patientname.append((doc.getElementsByTagName("ExtraProcessingInfo").item(0).getTextContent()));
                        ...
                        System.out.println();
                        System.out.println("******************************");
                        System.out.println("ExtraProcessingInfo Not getting the length");
                        System.out.println("******************************");
                        System.out.println();
                    }
                }
...
//                System.out.println("IN FIRST ELSE *************** ");
    ...
    private static void visitChildNotesExtraProcessingInfo(NodeList nList) {
        for (int temp = 0; temp < nList.getLength(); temp++) {
            ...
            if (node.getNodeType() == Node.ELEMENT_NODE) {
                ...
                System.out.println();
                System.out.println(" ******* IN visitChildNotesExtraProcessingInfo ****** ");
                Element eElement1 = (Element) node;
                System.out.println("string --> " + eElement1.getElementsByTagName("string").item(0).getTextContent());
                System.out.println("Message --> " + eElement1.getElementsByTagName("Message").item(0).getTextContent());
                ...
                if (node.hasAttributes()) {
                    ...
                    if (node.hasChildNodes()) {
                        System.out.println("Child Has Nodes ");
