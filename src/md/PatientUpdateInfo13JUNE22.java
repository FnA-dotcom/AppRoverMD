...
public class PatientUpdateInfo13JUNE22 extends HttpServlet {
...
//                    CDRList.append("<td align=left>" + rset.getString(3) + "</td>\n");//Number
                    ...
                    CDRList.append("<td><button id=addCovidDetail class=\"btn btn-primary btn-md\" data-toggle=\"modal\" data-target=\"#modal-left\" onclick=\"covidTracking(this.value)\" value=" + rset.getInt(15) + ">Tracker</button></td>");
                    if (patAddInfo > 0)
...
//                    CDRList.append("<td align=left>" + rset.getString(3) + "</td>\n");//Number
                    ...
                    CDRList.append("<td align=left>" + CovidStatusVL + "</td>\n");//COVID Status
                    CDRList.append("<td align=left>" + transactionType + "</td>\n");//Transaction Type
                    CDRList.append("<td><button id=addCovidDetail class=\"btn btn-primary btn-md\" data-toggle=\"modal\" data-target=\"#modal-left\" onclick=\"covidTracking(this.value)\" value=" + rset.getInt(10) + "> Tracker</button></td>");
                    if (patAddInfo > 0)
