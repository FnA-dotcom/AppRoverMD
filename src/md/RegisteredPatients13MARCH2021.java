...
public class RegisteredPatients13MARCH2021 extends HttpServlet {
    static String DOS = "";
    ...
    public void handleRequestold(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (ActionID.equals("GetValues")) {
                ...
                CollectPayment(request, response, out, conn, context, UserId, Database, ClientId);
                ...
                CollectPayment_View(request, response, out, conn, context, UserId, Database, ClientId);
                ...
                PayNow(request, response, out, conn, context, UserId, Database, ClientId);
    ...
    void PatientsDocUpload_Save(HttpServletRequest request, PrintWriter out, Connection conn, ServletContext servletContext, HttpServletResponse response, String Database, int ClientId) {
        ...
        try {
            ...
            try {
                PreparedStatement MainReceipt = conn.prepareStatement("Insert into " + Database + ".PatientDocUpload (PremisisId, PatientRegId, PatientMRN, PatientName, UploadDocumentName, FileName, CreatedBy, CreatedDate) values (?,?,?,?,?,?,?,now()) ");
    ...
    void TransactionReport(HttpServletRequest request, HttpServletResponse response, PrintWriter out, Connection conn, ServletContext servletContext, String UserId, String Database, int ClientId) {
        ...
        try {
            ...
            Query = " Select a.PatientMRN , CONCAT(b.Title,' ',b.FirstName,' ',b.MiddleInitial,' ',b.LastName), a.InvoiceNo, a.TotalAmount, " +
                    ...
                    "CASE WHEN PayMethod = 1 THEN 'Credit Card' WHEN PayMethod = 2 THEN 'Cash' WHEN PayMethod = 3 THEN 'BOLT Device' WHEN PayMethod = 4 THEN 'Cheque' ELSE '' END, " +
                    "IFNULL(PayMethod,0) " +
