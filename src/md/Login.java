    ...
    public void HandleRequest(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            try {
                ...
                Parser.GenerateHtml(out, String.valueOf(Services.GetHtmlPath(this.getServletContext())) + "index.html");
            } catch (Exception ex) {
            }
        }
        out.flush();
...
//            response.addCookie(username);
            ...
            Query = "SELECT name,menu,id FROM oe.clients WHERE Id = " + ClientIndex;
            hstmt = conn.createStatement();
            hrset = hstmt.executeQuery(Query);
            if (hrset.next()) {
                ClientId = hrset.getString(1).trim();
                menu = hrset.getString(2).trim();
                ClientIndex = hrset.getInt(3);
            }
            final Parsehtm Parser = new Parsehtm(request);
            ...
            System.out.println(String.valueOf(Services.GetHtmlPath(this.getServletContext())) + menu);
            if (UserType.equals("1")) {
                Parser.GenerateHtml(out, String.valueOf(Services.GetHtmlPath(this.getServletContext())) + "WelcomeMenu.html");
            } else if (UserType.equals("9")) {
                Parser.GenerateHtml(out, String.valueOf(Services.GetHtmlPath(this.getServletContext())) + "WelcomeMenuadmin.html");
            } else if (UserType.equals("3")) {
                Parser.GenerateHtml(out, String.valueOf(Services.GetHtmlPath(this.getServletContext())) + "main_wallboard.html");
            } else if (UserType.equals("4")) {
                Parser.GenerateHtml(out, String.valueOf(Services.GetHtmlPath(this.getServletContext())) + menu);
            } else if (UserType.equals("5")) {
                Parser.GenerateHtml(out, String.valueOf(Services.GetHtmlPath(this.getServletContext())) + "ob_supervisor_main.html");
            } else if (UserType.equals("6")) {
                Parser.GenerateHtml(out, String.valueOf(Services.GetHtmlPath(this.getServletContext())) + "WelcomeMenu_agent.html");
            }
        } catch (Exception e) {
    ...
    public void LoginAdmin(final HttpServletRequest request, final HttpServletResponse response, final PrintWriter out, final Connection conn, final ServletContext context1) {
        ...
        try {
            ...
            Query = "SELECT name,menu,FontColor FROM oe.clients WHERE Id = " + ClientIndex;
            hstmt = conn.createStatement();
            hrset = hstmt.executeQuery(Query);
            if (hrset.next()) {
                ClientId = hrset.getString(1).trim();
            ...
            Parser.SetField("UserType", String.valueOf(UserType));
            Parser.SetField("ClientIndex", String.valueOf(ClientIndex));
            Parser.SetField("FacilityIndex", String.valueOf(ClientIndex));
            Parser.SetField("FontColor", FontColor);
            if (UserType.equals("7")) {
                if (ClientIndex == 28 || ClientIndex == 27) {
                    ReportView.append("<li><a href=\"/md/md.PatientDemographics?ActionID=GetInput&FacilityIndex=" + ClientIndex + "\" target=\"NewFrame1\"><i class=\"ti-more\"></i><font color=\"white\">Patient Demographics</font></a></li>");
            ...
            try {
                final Parsehtm Parser2 = new Parsehtm(request);
                Parser2.SetField("Error", e.getMessage());
                Parser2.GenerateHtml(out, String.valueOf(Services.GetHtmlPath(this.getServletContext())) + "index2.html");
            } catch (Exception ex) {
            }
        }
    }
    ...
    public void Register(final HttpServletRequest request, final HttpServletResponse response, final PrintWriter out, final Connection conn, final ServletContext context1) {
        ...
        try {
            ...
            if (found2 == 1) {
                ...
                HTMLText = String.valueOf(HTMLText) + "<h1> OUR ENERGY BEST TEXAS ENERGY AND ELECTRIC COMPANY SERVICES SINCE 2009</h1>";
                HTMLText = String.valueOf(HTMLText) + "<p>Your Request has been Submitted to OE Team, </p>";
                HTMLText = String.valueOf(HTMLText) + "<p>You will received Approval Email at " + email + ". </p>";
                HTMLText = String.valueOf(HTMLText) + "<p></p>";
                HTMLText = String.valueOf(HTMLText) + "<p>Thank you<br>Regards,<br> Our Energy LLC</p>";
                ...
                final Parsehtm Parser = new Parsehtm(request);
                Parser.SetField("UserName", UNAME);
                Parser.GenerateHtml(out, String.valueOf(Services.GetHtmlPath(this.getServletContext())) + "successregister.html");
            } else {
                final Parsehtm Parser2 = new Parsehtm(request);
                Parser2.SetField("UserName", UNAME);
                Parser2.GenerateHtml(out, String.valueOf(Services.GetHtmlPath(this.getServletContext())) + "Unsuccessregister.html");
            }
        } catch (Exception e) {
            try {
                final Parsehtm Parser3 = new Parsehtm(request);
                Parser3.SetField("Error", e.getMessage());
                Parser3.GenerateHtml(out, String.valueOf(Services.GetHtmlPath(this.getServletContext())) + "register.html");
            } catch (Exception ex) {
            }
        }
    }
    ...
    public void forgetpassword(final HttpServletRequest request, final HttpServletResponse response, final PrintWriter out, final Connection conn, final ServletContext context1) {
        ...
        try {
            ...
            String HTMLText = "<h1> Dear " + UNAME + "</h1>";
            HTMLText = String.valueOf(HTMLText) + "<h1> OUR ENERGY BEST TEXAS ENERGY AND ELECTRIC COMPANY SERVICES SINCE 2009</h1>";
            HTMLText = String.valueOf(HTMLText) + "<p>Kindly Click on below link ,</p>";
            HTMLText = String.valueOf(HTMLText) + "<h2><a href=http://203.130.0.235:84/oe/oe.Login?Action=passwordreset&token=" + token + ">Reset Password</a></u></h2>";
            HTMLText = String.valueOf(HTMLText) + "<p>Above Link is valid for 24 hours only. </p>";
            HTMLText = String.valueOf(HTMLText) + "<p></p>";
            HTMLText = String.valueOf(HTMLText) + "<p>Thank you<br>Regards,<br> Our Energy LLC</p>";
            ...
            Parser.SetField("UserName", UNAME);
            Parser.GenerateHtml(out, String.valueOf(Services.GetHtmlPath(this.getServletContext())) + "forgetpasswordlink.html");
        } catch (Exception e) {
            try {
                final Parsehtm Parser2 = new Parsehtm(request);
                Parser2.SetField("Error", e.getMessage());
    ...
    public void passwordreset(final HttpServletRequest request, final HttpServletResponse response, final PrintWriter out, final Connection conn, final ServletContext context1) {
        ...
        try {
            ...
            final Parsehtm Parser = new Parsehtm(request);
            Parser.SetField("UserName", UNAME);
            Parser.GenerateHtml(out, String.valueOf(Services.GetHtmlPath(this.getServletContext())) + "resetpassword.html");
        } catch (Exception e) {
            try {
                final Parsehtm Parser2 = new Parsehtm(request);
                Parser2.SetField("Error", e.getMessage());
    ...
    public void passwordresetsave(final HttpServletRequest request, final HttpServletResponse response, final PrintWriter out, final Connection conn, final ServletContext context1) {
        ...
        try {
            ...
            HTMLText = String.valueOf(HTMLText) + "<h1> OUR ENERGY BEST TEXAS ENERGY AND ELECTRIC COMPANY SERVICES SINCE 2009</h1>";
            HTMLText = String.valueOf(HTMLText) + "<p>Password has been Reset</p>";
            HTMLText = String.valueOf(HTMLText) + "<p></p>";
            HTMLText = String.valueOf(HTMLText) + "<p>Thank you<br>Regards,<br> Our Energy LLC</p>";
            ...
            Parser.GenerateHtml(out, String.valueOf(Services.GetHtmlPath(this.getServletContext())) + "resetpassworddone.html");
        } catch (Exception e) {
            try {
                final Parsehtm Parser2 = new Parsehtm(request);
                Parser2.SetField("Error", e.getMessage());
                Parser2.SetField("token", token);
                Parser2.GenerateHtml(out, String.valueOf(Services.GetHtmlPath(this.getServletContext())) + "resetpassword.html");
            } catch (Exception ex) {
            }
        }
    }
    ...
    public void Logout(final HttpServletRequest request, final HttpServletResponse response, final PrintWriter out, final Connection conn, final ServletContext context) {
        ...
        try {
            ...
            if (usertype.equals("7")) {
                ...
                Parser.GenerateHtml(out, "/sftpdrive/opt/apache-tomcat-7.0.65/webapps/md/index.html");
            } else if (clientid == 8) {
                System.out.println(this.getServletContext() + "loginVictoria.html");
                Parser.GenerateHtml(out, "/sftpdrive/opt/apache-tomcat-7.0.65/webapps/md/loginOrange.html");
            } else if (clientid == 9) {
                System.out.println(this.getServletContext() + "loginVictoria.html");
                Parser.GenerateHtml(out, "/sftpdrive/opt/apache-tomcat-7.0.65/webapps/md/loginVictoria.html");
            } else if (clientid == 10) {
                System.out.println(this.getServletContext() + "loginVictoria.html");
                Parser.GenerateHtml(out, "/sftpdrive/opt/apache-tomcat-7.0.65/webapps/md/loginOddasa.html");
            } else if (clientid == 12) {
                System.out.println(this.getServletContext() + "loginSouthAustin.html");
                Parser.GenerateHtml(out, "/sftpdrive/opt/apache-tomcat-7.0.65/webapps/md/loginSAustin.html");
            } else if (clientid == 15) {
                System.out.println(this.getServletContext() + "loginSouthAustin.html");
                Parser.GenerateHtml(out, "/sftpdrive/opt/apache-tomcat-7.0.65/webapps/md/loginSublime.html");
            }
        } catch (Exception e) {
            ...
            try {
                ...
                final Parsehtm Parser2 = new Parsehtm(request);
                Parser2.SetField("Error", e.getMessage());
                Parser2.GenerateHtml(out, String.valueOf(Services.GetHtmlPath(context)) + "index.html");
