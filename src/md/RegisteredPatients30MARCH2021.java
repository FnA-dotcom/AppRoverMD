...
public class RegisteredPatients30MARCH2021 extends HttpServlet {
    static String DOS = "";
    static String Acct = "";
    ...
    public void handleRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (ActionID.equals("GetValues")) {
                ...
                PatientsDocUpload(request, out, conn, context, UserId, Database, ClientId);
                ...
                PatientsDocUpload_Save(request, out, conn, context, response, Database, ClientId);
                ...
                ViewDocuments_Input(request, out, conn, context, response, UserId, Database, ClientId);
                ...
                ViewDocuments(request, out, conn, context, response, UserId, Database, ClientId);
            } else if (ActionID.equals("DeleteDocument")) {
                supp.Dologing(UserId, conn, request.getRemoteAddr(), ActionID, "Delete Document", "Document is Deleted", ClientId);
                DeleteDocument(request, out, conn, context, response, UserId, Database, ClientId);
                ...
                CreateInvoiceInput(request, out, conn, context, response, UserId, Database, ClientId);
                ...
                GetCost(request, out, conn, context, response, UserId, Database, ClientId);
                ...
                SaveInvoice(request, out, conn, context, response, UserId, Database, ClientId);
            } else if (ActionID.equals("InvoicePdf")) {
                InvoicePdf(request, response, out, conn, UserId, Database, ClientId);
                ...
                CollectPayment(request, response, out, conn, context, UserId, Database, ClientId, helper);
                ...
                CollectPayment_View(request, response, out, conn, context, UserId, Database, ClientId, helper);
                ...
                PayNow(request, response, out, conn, context, UserId, Database, ClientId, helper, payments);
                ...
                PayNowSave(request, response, out, conn, context, UserId, Database, ClientId);
                ...
                DeActivePatient(request, response, out, conn, context, UserId, Database, ClientId);
                ...
                ReActivePatient(request, response, out, conn, context, UserId, Database, ClientId);
                ...
                DeActiveInvoice(request, response, out, conn, context, UserId, Database, ClientId);
                ...
                TransactionReport_Input(request, response, out, conn, context, UserId, Database, ClientId);
                ...
                TransactionReport(request, response, out, conn, context, UserId, Database, ClientId);
                ...
                AddDoctors(request, response, out, conn, context, UserId, Database, ClientId);
                ...
                SaveDoctor(request, response, out, conn, context, UserId, Database, ClientId);
                ...
                EditDoctor(request, response, out, conn, context, UserId, Database, ClientId);
                ...
                AddAlergyInfo(request, response, out, conn, context, UserId, Database, ClientId);
                ...
                SaveAllergy(request, response, out, conn, context, UserId, Database, ClientId);
                ...
                ShowHistory(request, response, out, conn, context, UserId, Database, ClientId);
            } else if (ActionID.equals("CashReceipt")) {
                supp.Dologing(UserId, conn, request.getRemoteAddr(), ActionID, "CashReceipt Download", "Show CashReceipt for Self Pay Patient Only", ClientId);
                CashReceipt(request, response, out, conn, context, UserId, Database, ClientId);
                ...
                GetPatients(request, response, out, conn, context, UserId, Database, ClientId);
                ...
                GetPatientsEligibility(request, response, out, conn, context, UserId, Database, ClientId);
                ...
                GetPatientsUploadDocs(request, response, out, conn, context, UserId, Database, ClientId);
                ...
                GetProfessionalPayersList(request, response, out, conn, context, UserId, Database, ClientId);
                ...
                RegisteredPatientListExcel(request, out, conn, context, UserId, Database, ClientId);
                ...
                DownloadPatientInput(request, out, conn, context, response, UserId, Database, ClientId);
                ...
                DownloadPatientList(request, out, conn, context, UserId, Database, ClientId);
            } else {
    ...
    public void handleRequestNEW(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException {
        String ActionID;
        ...
        try {
            ...
            if (ActionID.equals("GetValues")) {
                ...
                this.PatientsDocUpload(request, out, conn, context, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("ShowReport")) {
                ...
                this.ShowReport(request, out, conn, context, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("PatientsDocUpload_Save") && request.getContentType().startsWith("multipart/form-data")) {
                ...
                this.PatientsDocUpload_Save(request, out, conn, context, response, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("ViewDocuments_Input")) {
                supp.Dologing(UserId, conn, request.getRemoteAddr(), ActionID, "Patient Docs View", "Click on View Documents Options", FacilityIndex);
                this.ViewDocuments_Input(request, out, conn, context, response, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("ViewDocuments")) {
                supp.Dologing(UserId, conn, request.getRemoteAddr(), ActionID, "Patient Docs View", "Docmuents Uploaded List", FacilityIndex);
                this.ViewDocuments(request, out, conn, context, response, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("CreateInvoiceInput")) {
                ...
                this.CreateInvoiceInput(request, out, conn, context, response, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("GetCost")) {
                ...
                this.GetCost(request, out, conn, context, response, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("SaveInvoice")) {
                ...
                this.SaveInvoice(request, out, conn, context, response, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("InvoicePdf")) {
                this.InvoicePdf(request, response, out, conn, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("CollectPayment")) {
                ...
                this.CollectPayment(request, response, out, conn, context, UserId, DatabaseName, FacilityIndex, helper);
            } else if (ActionID.equals("CollectPayment_View")) {
                ...
                this.CollectPayment_View(request, response, out, conn, context, UserId, DatabaseName, FacilityIndex, helper);
            } else if (ActionID.equals("PayNow")) {
                ...
                this.PayNow(request, response, out, conn, context, UserId, DatabaseName, FacilityIndex, helper, payments);
            } else if (ActionID.equals("PayNowSave")) {
                ...
                this.PayNowSave(request, response, out, conn, context, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("DeActivePatient")) {
                ...
                this.DeActivePatient(request, response, out, conn, context, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("ReActivePatient")) {
                ...
                this.ReActivePatient(request, response, out, conn, context, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("DeActiveInvoice")) {
                ...
                this.DeActiveInvoice(request, response, out, conn, context, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("TransactionReport_Input")) {
                ...
                this.TransactionReport_Input(request, response, out, conn, context, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("TransactionReport")) {
                ...
                this.TransactionReport(request, response, out, conn, context, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("AddDoctors")) {
                ...
                this.SaveAllergy(request, response, out, conn, context, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("ShowHistory")) {
                ...
                this.ShowHistory(request, response, out, conn, context, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("GetPatients")) {
                ...
                this.GetPatients(request, response, out, conn, context, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("GetPatientsEligibility")) {
                ...
                this.GetPatientsEligibility(request, response, out, conn, context, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("GetPatientsUploadDocs")) {
                ...
                this.GetPatientsUploadDocs(request, response, out, conn, context, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("GetProfessionalPayersList")) {
                ...
                this.GetProfessionalPayersList(request, response, out, conn, context, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("RegisteredPatientListExcel")) {
                response.setContentType("application/vnd.ms-excel");
                response.setHeader("Content-Disposition", "attachment; filename=RoverPatientsList.xls");
                ...
                this.RegisteredPatientListExcel(request, out, conn, context, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("DownloadPatientInput")) {
                ...
                this.DownloadPatientInput(request, out, conn, context, response, UserId, DatabaseName, FacilityIndex);
            } else if (ActionID.equals("download_direct")) {
                ...
                this.DownloadPatientList(request, out, conn, context, UserId, DatabaseName, FacilityIndex);
            } else {
        ...
        try {
            ...
            try {
                PreparedStatement MainReceipt = conn.prepareStatement(
                        "Insert into " + Database + ".PatientDocUpload (PremisisId, PatientRegId, PatientMRN, PatientName, UploadDocumentName, " +
                                "FileName, CreatedBy, CreatedDate, DocumentType) values (?,?,?,?,?,?,?,now(),?) ");
...
//            out.println(Query);
    ...
    void CreateInvoiceInput(HttpServletRequest request, PrintWriter out, Connection conn, ServletContext servletContext, HttpServletResponse response, String UserId, String Database, int ClientId) {
        ...
        StringBuffer Footer = new StringBuffer();
        try {
            Query = "SELECT ID, CONCAT(IFNULL(Title,''),' ',IFNULL(FirstName,''),' ',IFNULL(MiddleInitial,''),' ',IFNULL(LastName,'')), MRN, DATE_FORMAT(DOB,'%d_%m-%Y') FROM " + Database + ".PatientReg where Status = 0 ";
            stmt = conn.createStatement();
            rset = stmt.executeQuery(Query);
            while (rset.next())
    ...
    private void InvoicePdf(HttpServletRequest request, HttpServletResponse response, PrintWriter out, Connection conn, String UserId, String Database, int ClientId) {
        ...
        try {
            ...
            try {
                //Changed the query
                //Not Getting record with accordance of Invoice no
/*                Query = "Select InvoiceNo, TotalAmount, PaidAmount, DATE_FORMAT(CreatedDate,'%m/%d/%Y') " +
                        "from " + Database + ".InvoiceMaster where PatientMRN = '" + PatientMRN + "' " +
            ...
            document.add((Element) new Paragraph("\n"));
            try {
                Query = " Select CONCAT(a.FirstName, ' ', a.MiddleInitial, ' ', a.LastName), b.name, a.Gender, " +
                        "DATE_FORMAT(a.DOB,'%m/%d/%Y'), a.Age,  DATE_FORMAT(a.CreatedDate,'%m/%d/%Y') as DOS " +
    ...
    void CollectPayment(HttpServletRequest request, HttpServletResponse response, PrintWriter out, Connection conn, ServletContext servletContext, String UserId, String Database, int ClientId, UtilityHelper helper) {
        Statement stmt = null;
        ResultSet rset = null;
        String Query = "";
        SupportiveMethods suppMethods = new SupportiveMethods();
...
/*            out.println(var11.getMessage());
    ...
    void CollectPayment_ViewOLD(HttpServletRequest request, HttpServletResponse response, PrintWriter out, Connection conn, ServletContext servletContext, String UserId, String Database, int ClientId, UtilityHelper helper) {
        Statement stmt = null;
        ResultSet rset = null;
    ...
    void CollectPayment_View(HttpServletRequest request, HttpServletResponse response, PrintWriter out, Connection conn, ServletContext servletContext, String UserId, String Database, int ClientId, UtilityHelper helper) {
        Statement stmt = null;
        ResultSet rset = null;
        Statement stmt2 = null;
        ResultSet rset2 = null;
        ...
        try {
            ...
            Query = " SELECT a.PatientMRN, CONCAT(b.Title,' ',b.FirstName,' ',b.MiddleInitial,' ',b.LastName), DATE_FORMAT(b.DOB,'%d-%m-%Y')," +
...
//                CDRList.append("<td align=left>" + rset.getString(3) + "</td>\n");
            ...
            helper.SendEmailWithAttachment("Error in RegisteredPatients ** (CollectPayment_View)", servletContext, var11, "RegisteredPatients", "CollectPayment_View", conn);
            Services.DumException("Registered Patients", "CollectPayment_View", request, var11, getServletContext());
            Parsehtm Parser = new Parsehtm(request);
...
/*            out.println(Query);
    ...
    void PayNow(HttpServletRequest request, HttpServletResponse response, PrintWriter out, Connection conn, ServletContext servletContext, String UserId, String Database, int ClientId, UtilityHelper helper, Payments payments) {
        stmt = null;
        rset = null;
        Query = "";
        ...
        try {
            Query = "SELECT a.PatientMRN, CONCAT(b.Title,' ',b.FirstName,' ',b.MiddleInitial,' ',b.LastName), a.TotalAmount," +
                    " a.PaidAmount,a.BalAmount,IFNULL(DATE_FORMAT(b.DateofService,'%m/%d/%Y %T'),DATE_FORMAT(b.CreatedDate,'%m/%d/%Y %T')) AS DOS  " +
                    " FROM " + Database + ".InvoiceMaster a " +
                    " LEFT JOIN " + Database + ".PatientReg b on a.PatientMRN = b.MRN " +
...
/*            out.println(Query);
    ...
    void PayNowSave(HttpServletRequest request, HttpServletResponse response, PrintWriter out, Connection conn, ServletContext servletContext, String UserId, String Database, int ClientId) {
        ...
        try {
            ...
            try {
                PreparedStatement MainReceipt = conn.prepareStatement(
                        "INSERT INTO " + Database + ".PaymentReceiptInfo (PatientMRN,InvoiceNo,TotalAmount, PaidAmount,Paid,RefNo,Remarks," +
                                "PayMethod,CreatedDate, BalAmount) \nVALUES (?,?,?,?,?,?,?,?,now(),?) ");
                MainReceipt.setString(1, PatientMRN);
                MainReceipt.setString(2, InvoiceNo);
                MainReceipt.setDouble(3, TotalAmount);
