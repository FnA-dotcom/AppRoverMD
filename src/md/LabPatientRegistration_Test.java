...
public class LabPatientRegistration_Test extends HttpServlet {
...
//            Parser.GenerateHtml(out, Services.GetHtmlPath(getServletContext()) + "Forms/PRF_files/" + PRF_name);
            Parser.GenerateHtml(out, Services.GetHtmlPath(getServletContext()) + "Forms/PRF_files/CovidReg_Test.html");
        } catch (Exception ex) {
            //helper.SendEmailWithAttachment("Error in LabPatientRegistration ** (GetValues^^" + facilityName + ")", servletContext, ex, "LabPatientRegistration", "GetValues", conn);
            Services.DumException("GetValues^^" + facilityName + "", "LabPatientRegistration ", request, ex);
            Parsehtm Parser = new Parsehtm(request);
...
//            out.print("temp "+ temp);
            ...
            Parser.SetField("FormName", "LabPatientRegistration_Test");
            Parser.SetField("ActionID", "GetValues&ClientIndex=" + ClientIndex);
            ...
            helper.SendEmailWithAttachment("Error in LabPatientRegistration_Test ** (SaveData Main Catch^^" + facilityName + " ##MES#014)", servletContext, ex, "LabPatientRegistration_Test", "SaveData", conn);
            Services.DumException("SaveData^^" + facilityName + " ##MES#014", "LabPatientRegistration_Test ", request, ex);
            Parsehtm Parser = new Parsehtm(request);
            Parser.SetField("FormName", "LabPatientRegistration_Test");
            Parser.SetField("ActionID", "GetValues&ClientIndex=" + ClientIndex + "");
...
//          Insert Data in the SignRequest Table here.
            ...
            Parser.GenerateHtml(out, Services.GetHtmlPath(servletContext) + "Forms/SigningBundleRoverLab_Test.html");
    ...
    void PayNow(HttpServletRequest request, HttpServletResponse response, PrintWriter out, Connection conn, ServletContext servletContext, String UserId, String Database, int ClientId, UtilityHelper helper, Payments payments) throws FileNotFoundException {
        ...
        try {
            ...
            if(rqtype.equals("nullGetValues")){
                ...
                Parser.SetField("WEB", "/md/md.LabPatientRegistration_Test?ActionID=GetValues");
            }
