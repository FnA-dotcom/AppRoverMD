...
//      System.out.println(PatientCountMonthly);
    ...
    void GetReport(final HttpServletRequest request, final PrintWriter out, final Connection conn, final ServletContext servletContext, String UserId, String Database, int ClientId, String FontColor) {
        SupportiveMethods suppMethods = new SupportiveMethods();
        StringBuffer LeftSideBarMenu = new StringBuffer();
        StringBuffer Header = new StringBuffer();
        StringBuffer Footer = new StringBuffer();
        ...
        try {
            ...
            while (rset.next()) {
                _FromEndDate = rset.getString(1);
                _ToEndDate = rset.getString(1);
                Query1 = "Select COUNT(*) from " + Database + ".PatientReg where Status = 0 and DateofService >= '" + _FromEndDate + " 00:00:00' and DateofService <= '" + _ToEndDate + " 23:59:59'";
                stmt1 = conn.createStatement();
                rset1 = stmt1.executeQuery(Query1);
                while (rset1.next()) {
                    PatientsCurrentMonthDaily += rset1.getInt(1) + " , ";
            ...
            Query = "Select COUNT(*) from " + Database + ".PatientReg where Status = 0 and  DateofService >= '" + FromDate + " 00:00:00' and DateofService <= '" + ToDate + " 23:59:59'";
            stmt = conn.createStatement();
            rset = stmt.executeQuery(Query);
            if (rset.next()) {
                PatientCountCurrentMonth = rset.getInt(1);
            ...
            Query = "Select COUNT(*) from " + Database + ".PatientReg where Status = 0 and  DateofService >= '" + FDate + " 00:00:00' and DateofService <= '" + TDate + " 23:59:59'";
            stmt = conn.createStatement();
            rset = stmt.executeQuery(Query);
            if (rset.next()) {
                PatientCountOverAll = rset.getInt(1);
            ...
            Query = "Select COUNT(*) from " + Database + ".PatientReg where Status = 0 and ltrim(rtrim(UPPER(Gender))) = ltrim(rtrim(UPPER('male'))) and  DateofService >= '" + FDate + " 00:00:00' and DateofService <= '" + TDate + " 23:59:59'";
            stmt = conn.createStatement();
            rset = stmt.executeQuery(Query);
            if (rset.next()) {
                PatientCountMale = rset.getInt(1);
            ...
            if (ClientId == 9 || ClientId == 28) {
                ...
                Query = "Select COUNT(*) from " + Database + ".PatientReg where Status = 0 and SelfPayChk = 1 and  DateofService >= '" + FDate + " 00:00:00' and DateofService <= '" + TDate + " 23:59:59'";
                stmt = conn.createStatement();
                rset = stmt.executeQuery(Query);
                if (rset.next()) {
                    PatientCountInsured = rset.getInt(1);
            ...
            if (ClientId == 9 || ClientId == 28) {
                ...
                Query = "Select COUNT(*) from " + Database + ".InsuranceInfo where WorkersCompPolicy = 1 and  CreatedDate >= '" + FDate + " 00:00:00' and CreatedDate <= '" + TDate + " 23:59:59'";
                stmt = conn.createStatement();
                rset = stmt.executeQuery(Query);
                if (rset.next()) {
                    PatientCountWC = rset.getInt(1);
            ...
            if (ClientId == 9 || ClientId == 28) {
                ...
                Query = "Select COUNT(*) from " + Database + ".InsuranceInfo where MotorVehAccident = 1 and  CreatedDate >= '" + FDate + " 00:00:00' and CreatedDate <= '" + TDate + " 23:59:59'";
                stmt = conn.createStatement();
                rset = stmt.executeQuery(Query);
                if (rset.next()) {
                    PatientCountMVA = rset.getInt(1);
            ...
            //Query = "Select COUNT(*) from " + Database + ".PatientReg where Status = 0 and ltrim(rtrim(UPPER(ReasonVisit))) =  'COVID TESTING'";
            Query = "Select COUNT(*) from " + Database + ".PatientReg where Status = 0 and COVIDStatus = 1 and  DateofService >= '" + FDate + " 00:00:00' and DateofService <= '" + TDate + " 23:59:59'";
            stmt = conn.createStatement();
            rset = stmt.executeQuery(Query);
            if (rset.next()) {
                PatientCountCOVID = rset.getInt(1);
