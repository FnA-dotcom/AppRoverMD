...
public class PatientReg13MARCH2021 extends HttpServlet {
        ...
        try {
            ...
            switch (ActionID) {
                ...
                case "ReasonVisits":
                    ...
                    break;
                case "TabishTest":
                    this.TabishTest(request, out, conn, context, DatabaseName);
                    break;
                default:
    ...
    void TabishTest(final HttpServletRequest request, final PrintWriter out, final Connection conn, final ServletContext servletContext, String Database) {
        try {
            Parsehtm Parser = new Parsehtm(request);
            Parser.GenerateHtml(out, Services.GetHtmlPath(servletContext) + "Forms/PRF_files/TabishValidation.html");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
...
//            Parser.GenerateHtml(out, Services.GetHtmlPath(this.getServletContext()) + "Forms/PRF_files/TabishValidation.html");
        } catch (Exception ex) {
