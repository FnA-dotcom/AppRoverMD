...
public class finaltrizetto3 {
    ...
    public static void callSoapWebService(String soapEndpointUrl, String soapAction, String GediPayerID, String NPI, String FirstName, String LastName, String InsuranceNum, String DOB, String Gender, String GPN, String PatientId, String UserId, String proname, String service_Type, int ClientId) {
        try {
...
/*            String msg = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:gat=\"GatewayEDI.WebServices\">" +
            ...
            // Service Type Parameter added - 20 FEb 2021
            String msg = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:gat=\"GatewayEDI.WebServices\">" +
                    "<soapenv:Header><gat:AuthSOAPHeader><gat:User>4FRG</gat:User><gat:Password>waz3adro</gat:Password></gat:AuthSOAPHeader></soapenv:Header>" +
                    "<soapenv:Body><gat:DoInquiry><gat:Inquiry><gat:Parameters>" +
                    "<gat:MyNameValue><gat:Name>GediPayerID</gat:Name><gat:Value>" + GediPayerID + "</gat:Value></gat:MyNameValue>" +
                    ...
                    GPNmsg +
                    "<gat:MyNameValue><gat:Name>InsuredGender</gat:Name><gat:Value>" + Gender + "</gat:Value></gat:MyNameValue>" +
                    "<gat:MyNameValue><gat:Name>ServiceTypeCode</gat:Name><gat:Value>" + service_Type + "</gat:Value></gat:MyNameValue>" +
                    "</gat:Parameters><gat:ResponseDataType>Xml</gat:ResponseDataType></gat:Inquiry></gat:DoInquiry></soapenv:Body></soapenv:Envelope>";
...
//            System.out.println(replaceChars(strMsg));
            ...
            eiresponse3.parmsg(strMsg, PatientId, ClientId);
//            System.out.println("+++++++++++++++++++++++ TABISH 123 ++++++++++++++++++++++++++++++++");
/*            System.out.println("msg " + msg);
            ...
            try {
                ...
                PreparedStatement MainReceipt = conn.prepareStatement(
                        "INSERT INTO oe.FinalTrizetto (Req_msg,Resp_strmsg,PatientMRN ,CreatedDate,Createdby) " +
                                "VALUES (?,?,?,now(), ?) ");
                ...
                //Services.DumException("Final Trizetto ", "Saving Table Exception Final Trizetto", request, e, servletContext);
                pushLogs("Insertion Final Trizetto Table ", e);
                System.out.println("Error 2 - Insertion Final Trizetto Table :" + e.getMessage() + " --> " + test);
                return;
            }
        } catch (Exception e) {
            System.err.println("\nError occurred while sending SOAP Request to Server!\nMake sure you have the correct endpoint URL and SOAPAction!\n");
            pushLogs("Error in Sending SOAP Request to Server ", e);
        }
    }
