...
public class RegisteredPatients2MARCH2021 extends HttpServlet {
    static String DOS = "";
    static String Acct = "";
    ...
    public void handleRequest(final HttpServletRequest request, final HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (ActionID.equals("GetValues")) {
                ...
                this.CollectPayment(request, response, out, conn, context, UserId, DatabaseName, FacilityIndex);
                ...
                this.CollectPayment_View(request, response, out, conn, context, UserId, DatabaseName, FacilityIndex);
                ...
                this.PayNow(request, response, out, conn, context, UserId, DatabaseName, FacilityIndex);
    ...
    void ShowReport(final HttpServletRequest request, final PrintWriter out, final Connection conn, final ServletContext servletContext, final String UserId, final String Database, final int ClientId) {
        ...
        try {
            ...
            if (PatientCount > 0) {
                ...
                rset.close();
                stmt.close();
//                System.out.println(BundleFnName);
//                System.out.println(LabelFnName);
                ...
                Query = "SELECT CONCAT(IFNULL(Title,''),' ',IFNULL(FirstName,''),' ',IFNULL(MiddleInitial,''),' ',IFNULL(LastName,'')), DATE_FORMAT(DOB,'%m/%d/%Y'), IFNULL(PhNumber,''), " +
                        ...
                        "CASE WHEN COVIDStatus = 1 THEN 'POSITIVE' WHEN COVIDStatus = 0 THEN 'NEGATIVE'  WHEN COVIDStatus = -1 THEN 'SUSPECTED' ELSE 'NONE' END " +
...
//                    CDRList.append("<td align=left><a href=/md/md.PatientUpdateInfo_old?ActionID=GetInput&ID=" + rset.getInt(6) + ">Update Info</a></td>\n");
...
//                    CDRList.append("<td align=left><a href=/md/md.PrintLabel4?ActionID="+LabelFnName+"&ID=" + rset.getInt(6) + ">Print Label</a></td>\n");
//                    CDRList.append("<td align=left><a href=/md/md.DownloadBundle?ActionID="+BundleFnName+"&ID=" + rset.getInt(6) + ">Downlaod Admission Bundle</a></td>\n");
////                    if (ClientId == 8) {
////                        CDRList.append("<td align=left><a href=/md/md.PrintLabel4?ActionID=GETINPUT&ID=" + rset.getInt(6) + ">Print Label</a></td>\n");
////                        CDRList.append("<td align=left><a href=/md/md.DownloadBundle?ActionID=GETINPUT&ID=" + rset.getInt(6) + ">Downlaod Admission Bundle</a></td>\n");
////                    } else if (ClientId == 9) {
////                        CDRList.append("<td align=left><a href=/md/md.PrintLabel4?ActionID=GETINPUTVictoria&ID=" + rset.getInt(6) + ">Print Label</a></td>\n");
////                        CDRList.append("<td align=left><a href=/md/md.DownloadBundle?ActionID=GETINPUTVictoria&ID=" + rset.getInt(6) + ">Downlaod Admission Bundle</a></td>\n");
////                    } else if (ClientId == 10) {
////                        CDRList.append("<td align=left><a href=/md/md.PrintLabel4?ActionID=GETINPUT&ID=" + rset.getInt(6) + ">Print Label</a></td>\n");
////                        CDRList.append("<td align=left><a href=/md/md.DownloadBundle?ActionID=GETINPUTOddasa&ID=" + rset.getInt(6) + ">Downlaod Admission Bundle</a></td>\n");
////                    } else if (ClientId == 12) {
////                        CDRList.append("<td align=left><a href=/md/md.PrintLabel4?ActionID=GETINPUT&ID=" + rset.getInt(6) + ">Print Label</a></td>\n");
////                        CDRList.append("<td align=left><a href=/md/md.DownloadBundle?ActionID=GETINPUTSAustin&ID=" + rset.getInt(6) + ">Downlaod Admission Bundle</a></td>\n");
////                    }
//                    CDRList.append("<td align=left><a href=/md/md.RegisteredPatients?ActionID=ShowHistory&ID=" + rset.getInt(6) + ">Show History</a></td>\n");
////                  CDRList.append("<td align=left><a href=/md/md.RegisteredPatients?ActionID=UpdateAgeVictoria>Show History</a></td>\n");
//                    CDRList.append("<td align=left><a href=/md/md.PatientCharts?ActionID=GetChartList&MRN=" + rset.getString(4) + "&clientdirectory=" + ClientId + " target='_blank'>Chart List</a></td>\n");
//                    if (ClientId == 9) {
...
//                    }else{
//                        CDRList.append("<td align=left><a href=/md/md.PatientReg?ActionID=EditValues_New&MRN=" + rset.getString(4).trim() + "&ClientId=" + ClientId + ">View/Edit</a></td>\n");
//                    }
//                    CDRList.append("<td align=left><a href=/md/md.PatientInfo?ActionID=GetValues&ID=" + rset.getInt(6) + ">Send to E-Doc</a></td>\n");
//
////                    CDRList.append("<td align=left><a href=/md/md.RegisteredPatients?ActionID=DeActivePatient&ID=" + rset.getInt(6) + ">De-Activate Patient</a></td>\n");
//                    CDRList.append("<td align=left><button id=deleteBtn onclick=\"DeactivatePatient(this.value)\" class=\"btn btn-danger btn-sm\" value=" + rset.getInt(6) + " target=NewFrame1> <font color = \"FFFFFF\"> <i class=\"fa fa-trash-o\"></i> [De-Activate] </font></button></td>\n");
////                  CDRList.append("<td align=left><a href=/md/md.RegisteredPatients?ActionID=ReActivePatient&ID=" + rset.getInt(6) + ">Re-Activate Patient</a></td>\n");
//                    CDRList.append("</tr>");
                    ++SNo;
                }
                rset.close();
...
//    final String Path = "/opt/apache-tomcat-7.0.65/webapps/orange_2/Attachment";
        ...
        String FileName = "";
        try {
            Dictionary d = this.doUpload(request, response, out);
            ...
            try {
                final PreparedStatement MainReceipt = conn.prepareStatement("Insert into " + Database + ".PatientDocUpload (PremisisId, PatientRegId, PatientMRN, PatientName," + " UploadDocumentName, FileName, CreatedBy, CreatedDate) values (?,?,?,?,?,?,?,now()) ");
...
//        File dest = new File(String.valueOf( "/opt/"+FileName));
                ...
                int CopyResult = copyFileUsingJava7Files(source, dest);
//                if (CopyResult == 1) {
...
//                    }
//                    try {
//                        final PreparedStatement MainReceipt = conn.prepareStatement("INSERT INTO " + "oe" + ".filelogs_sftp (target, entrydate, clientdirectory, " +
//                                "filename , acc, " +
...
//                        out.println("Error in Insertion:-" + e.getMessage());
//                    }
//                    Message = " and Chart Copied to the Directory Succesfully";
//                } else {
//                    Message = " and Chart is already present in the folder";
//                }
                // String cc= datainsert_new(FileName, dosdate, acc, epowertime, path, firstname, lastname, PatientMRN, ClientId, conn);
            }

            final Parsehtm Parser = new Parsehtm(request);
            Parser.SetField("Message", String.valueOf("File Has been Uploaded Succesfully" + Message));
    ...
    void CreateInvoiceInput(final HttpServletRequest request, final PrintWriter out, final Connection conn, final ServletContext servletContext, final HttpServletResponse response, final String UserId, final String Database, final int ClientId) {
        ...
        try {
            ...
            stmt = conn.createStatement();
            rset = stmt.executeQuery(Query);
            diseaseList.append("<option class=Inner value=''>Select Disease </option>");
            while (rset.next()) {
    ...
    void SaveInvoice(final HttpServletRequest request, final PrintWriter out, final Connection conn, final ServletContext servletContext, final HttpServletResponse response, final String UserId, final String Database, final int ClientId) {
        ...
        try {
            ...
            try {
                final PreparedStatement MainReceipt = conn.prepareStatement("INSERT INTO " + Database + ".InvoiceMaster (PatientMRN,InvoiceNo,TotalAmount ,PaidAmount,Paid," + "PaymentDateTime,InvoiceCreatedBy ,CreatedDate, Status, BalAmount,InstallmentApplied) \n" + "VALUES (?,?,?,?,?,?,?,now(),0,?,0) ");
    ...
    void CollectPayment(final HttpServletRequest request, final HttpServletResponse response, final PrintWriter out, final Connection conn, final ServletContext servletContext, final String UserId, final String Database, final int ClientId) {
        ...
        try {
            Query = " SELECT a.PatientMRN, CONCAT(b.Title,' ',b.FirstName,' ',b.MiddleInitial,' ',b.LastName), DATE_FORMAT(b.DOB,'%m/%d/%Y') " +
                    ...
                    " LEFT JOIN " + Database + ".PatientReg b ON a.PatientMRN = b.MRN where b.Status = 0 " +
                    " GROUP BY a.PatientMRN";
            stmt = conn.createStatement();
            rset = stmt.executeQuery(Query);
            while (rset.next()) {
    ...
    void CollectPayment_View(final HttpServletRequest request, final HttpServletResponse response, final PrintWriter out, final Connection conn, final ServletContext servletContext, final String UserId, final String Database, final int ClientId) {
        ...
        try {
            ...
            //out.println(PatientInvoiceMRN+": PatientInvoiceMRN <br>");
...
//        CDRList.append("<td align=left><a href=" + DocumentPath + " target=\"_blank\">" + "ViewInvoice_" + rset.getString(1) + "</a></td>\n");
                CDRList.append("<td align=left><a href=/md/md.RegisteredPatients?ActionID=InvoicePdf&PatientMRN=" + rset.getString(1) + ">" + "ViewInvoice_" + rset.getString(1) + "</a></td>\n");
    ...
    void PayNow(final HttpServletRequest request, final HttpServletResponse response, final PrintWriter out, final Connection conn, final ServletContext servletContext, final String UserId, final String Database, final int ClientId) {
        ...
        try {
            ...
            if (BalAmount == 0.00) {
                Parsehtm Parser = new Parsehtm(request);
                Parser.SetField("Message", "Payment has already been paid!");
            ...
            try {
                final PreparedStatement MainReceipt = conn.prepareStatement(
                        "INSERT INTO " + Database + ".PaymentReceiptInfo (PatientMRN,InvoiceNo,TotalAmount,PaidAmount,Paid,RefNo,Remarks," +
                                "PayMethod,CreatedDate, BalAmount) VALUES (?,?,?,?,?,?,?,?,now(),?) ");
                MainReceipt.setString(1, PatientMRN);
                MainReceipt.setString(2, InvoiceNo);
                MainReceipt.setDouble(3, TotalAmount);
...
//                System.out.println(Query);
            ...
            if (Found > 0) {
                ...
                final ByteArrayOutputStream baos = new ByteArrayOutputStream();
                PdfWriter.getInstance(document, (OutputStream) baos);
                PdfWriter.getInstance(document, (OutputStream) new FileOutputStream(Path + "/opt/apache-tomcat-7.0.65/webapps/md/Attachment/PatientHistory_" + MRN + "_" + PatientName + ".pdf"));
    ...
    void GetPatients(final HttpServletRequest request, final HttpServletResponse response, final PrintWriter out, final Connection conn, final ServletContext servletContext, final String UserId, final String Database, final int ClientId) {
        try {
            ...
            Query = " Select Id, MRN, FirstName, MiddleInitial, LastName, DOB, PhNumber " +
                    " from " + Database + ".PatientReg where status = 0 and FirstName like '%" + Patient + "%' OR LastName like '%" + Patient + "%' " + " OR MRN like '%" + Patient + "%' OR PhNumber like '%" + Patient + "%' OR MiddleInitial like '%" + Patient + "%' ";
    ...
    void GetPatientsUploadDocs(final HttpServletRequest request, final HttpServletResponse response, final PrintWriter out, final Connection conn, final ServletContext servletContext, final String UserId, final String Database, final int ClientId) {
        try {
            ...
            final String Patient = request.getParameter("Patient").trim();
            final StringBuffer PatientList = new StringBuffer();
            Query = " Select Id, IFNULL(MRN,''), IFNULL(FirstName,''), IFNULL(MiddleInitial,''), IFNULL(LastName,''), IFNULL(DOB,''), IFNULL(PhNumber,''), " +
                    " CONCAT(ID,',',IFNULL(MRN,''),',',IFNULL(Title,''),' ',IFNULL(FirstName,''),' ',IFNULL(MiddleInitial,''),' ',IFNULL(LastName,'')) " +
