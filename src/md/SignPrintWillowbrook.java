...
public class SignPrintWillowbrook extends HttpServlet {
...
*/
            ...
            FacilityIndex = 41;
            System.out.println("WILLOWWW " + FacilityIndex);
            ...
            Query = "Select Bundle_FnName,dbname,DirectoryName from oe.clients where Id = " + FacilityIndex;
            stmt = conn.createStatement();
            rset = stmt.executeQuery(Query);
            if (rset.next()) {
                Bundle_Name = rset.getString(1);
                DatabaseName = rset.getString(2);
...
//          Insert Data in the SignRequest Table here.
            ...
            Parser.SetField("FacilityIndex", String.valueOf(ClientId));
            Parser.SetField("UserId", UserId);
            Parser.GenerateHtml(out, Services.GetHtmlPath(servletContext) + "Forms/SigningBundleWillow.html");
