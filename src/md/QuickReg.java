...
//                out.println("You are not Authorized to access this page");
            ...
            switch (ActionID) {
                case "GetValues":
                    ...
                    GetValues(request, out, conn, context, UserId, DatabaseName, "", helper);
                    break;
                case "SaveData":
                    ...
                    SaveData(request, out, conn, context, UserId, response, DatabaseName, "", helper);
                    break;
                case "Victoria_2":
                    ...
                    Victoria_2(request, out, conn, context, UserId, response, DatabaseName, "", helper);
                    break;
            }
        } catch (Exception e) {
            helper.SendEmailWithAttachment("Error in PatientReg ** (handleRequest)", context, e, "QuickReg", "handleRequest", conn);
            Services.DumException("QuickReg", "Handle Request", request, e, getServletContext());
            Parsehtm Parser = new Parsehtm(request);
            Parser.SetField("FormName", "ManagementDashboard");
            Parser.SetField("ActionID", "GetInput");
            ...
            try {
                ...
                e.printStackTrace();
                helper.SendEmailWithAttachment("Error in QuickReg ** (handleRequest -- SqlException)", context, e, "QuickReg", "handleRequest", conn);
                Services.DumException("QuickReg", "Handle Request", request, e, getServletContext());
                Parsehtm Parser = new Parsehtm(request);
                Parser.SetField("FormName", "ManagementDashboard");
                Parser.SetField("ActionID", "GetInput");
    ...
    void GetValues(final HttpServletRequest request, final PrintWriter out, final Connection conn, final ServletContext servletContext, final String UserId, final String Database, String FontColor, UtilityHelper helper) throws FileNotFoundException {
        String facilityName = "";
        try {
...
//            System.out.println("Database: " + Database);
            ...
            Parser.GenerateHtml(out, Services.GetHtmlPath(getServletContext()) + "Forms/" + QRF_name);
        } catch (Exception ex) {
            helper.SendEmailWithAttachment("Error in QuickReg ** (GetValues^^" + facilityName + ")", servletContext, ex, "QuickReg", "GetValues", conn);
            Services.DumException("GetValues^^" + facilityName + "", "QuickReg ", request, ex);
            Parsehtm Parser = new Parsehtm(request);
            Parser.SetField("FormName", "ManagementDashboard");
            Parser.SetField("ActionID", "GetInput");
    ...
    void SaveData(final HttpServletRequest request, final PrintWriter out, final Connection conn, final ServletContext servletContext, final String UserId, final HttpServletResponse response, final String Database, String FontColor, UtilityHelper helper) throws FileNotFoundException {
        Statement stmt = null;
        ResultSet rset = null;
        String Query = "";
        int PatientRegId = 0;
...
//                }
                ...
                if (request.getParameter("DoctorName") == null) {
                    ...
                    DoctorsId = request.getParameter("DoctorName").trim();
                }
                ...
                helper.SendEmailWithAttachment("Error in QuickReg ** (SaveData^^" + facilityName + " ##MES#004)", servletContext, ex, "QuickReg", "SaveData", conn);
                Services.DumException("SaveData^^" + facilityName + " ##MES#004-0", "QuickReg ", request, ex);
                Parsehtm Parser = new Parsehtm(request);
                Parser.SetField("FormName", "QuickReg");
                Parser.SetField("ActionID", "GetValues&ClientIndex=" + ClientIndex + "");
                Parser.SetField("Message", "MES#004-0");
                Parser.GenerateHtml(out, Services.GetHtmlPath(servletContext) + "Exception/ExceptionMessage.html");
                return;
            }
            try {
                ...
                helper.SendEmailWithAttachment("Error in QuickReg ** (SaveData^^" + facilityName + ")", servletContext, ex, "QuickReg", "SaveData", conn);
                Services.DumException("SaveData^^" + facilityName + "", "QuickReg ", request, ex);
                Parsehtm Parser = new Parsehtm(request);
                Parser.SetField("FormName", "QuickReg");
                Parser.SetField("ActionID", "GetInput&ClientIndex=" + ClientIndex + "");
            ...
            try {
                PreparedStatement MainReceipt = conn.prepareStatement("INSERT INTO " + Database + ".PatientReg (ClientIndex,FirstName,LastName ,MiddleInitial,DOB,Age," +
                        ...
                        "CreatedDate,Title, MaritalStatus,CreatedBy, MRN, Status, DoctorsName, DateofService, ExtendedMRN, Address2, " +
                        "StreetAddress2, County,RegisterFrom,ViewDate,EnterBy,EnterIP) \n" +
                        "VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,now(),?,?,?,?,0,?,?,?,?,?,?,?,NOW(),?,?) ");
                ...
                MainReceipt.setInt(26, Integer.parseInt(DoctorsId));
                ...
                MainReceipt.setString(32, "Quick Reg Form");
                MainReceipt.setString(33, UserId);
                MainReceipt.setString(34, ClientIp);
                MainReceipt.executeUpdate();
                MainReceipt.close();
            } catch (Exception ex) {
                helper.SendEmailWithAttachment("Error in QuickReg ** (SaveData Insertion PatientReg^^" + facilityName + " ##MES#005)", servletContext, ex, "QuickReg", "SaveData", conn);
                Services.DumException("SaveData^^" + facilityName + " ##MES#003", "QuickReg ", request, ex);
                Parsehtm Parser = new Parsehtm(request);
                Parser.SetField("FormName", "QuickReg");
                Parser.SetField("ActionID", "GetValues&ClientIndex=" + ClientIndex + "");
            ...
            try {
                final PreparedStatement MainReceipt = conn.prepareStatement("INSERT INTO " + Database + ".PatientVisit(MRN,PatientRegId,ReasonVisit," +
                        "VisitNumber,DoctorId,DateofService,CreatedDate,CreatedBy) VALUES (?,?,?,1,NULL,?,now(),?) ");
                ...
                helper.SendEmailWithAttachment("Error in QuickReg ** (SaveData Insertion PatientVisit^^" + facilityName + " ##MES#004)", servletContext, ex, "QuickReg", "SaveData", conn);
                Services.DumException("SaveData^^" + facilityName + " ##MES#004", "QuickReg ", request, ex);
                Parsehtm Parser = new Parsehtm(request);
                Parser.SetField("FormName", "QuickReg");
                Parser.SetField("ActionID", "GetValues&ClientIndex=" + ClientIndex + "");
            ...
            try {
                ...
                helper.SendEmailWithAttachment("Error in QuickReg ** (SaveData Insertion PatientReg_Details^^" + facilityName + " ##MES#006)", servletContext, ex, "QuickReg", "SaveData", conn);
                Services.DumException("SaveData^^" + facilityName + " ##MES#006", "QuickReg ", request, ex);
                Parsehtm Parser = new Parsehtm(request);
                Parser.SetField("FormName", "QuickReg");
                Parser.SetField("ActionID", "GetValues&ClientIndex=" + ClientIndex + "");
            ...
            try {
                if (ClientIndex == 10 || ClientIndex == 15) {
                    try {
                        ...
                        helper.SendEmailWithAttachment("Error in QuickReg ** (SaveData Insertion PatientAdmissionBundle^^" + facilityName + " ##MES#007)", servletContext, ex, "QuickReg", "SaveData", conn);
                        Services.DumException("SaveData^^" + facilityName + " ##MES#007", "QuickReg ", request, ex);
                        Parsehtm Parser = new Parsehtm(request);
                        Parser.SetField("FormName", "QuickReg");
                        Parser.SetField("ActionID", "GetValues&ClientIndex=" + ClientIndex + "");
                ...
                helper.SendEmailWithAttachment("Error in QuickReg ** (SaveData Insertion InsuranceInfo^^" + facilityName + " ##MES#008)", servletContext, ex, "QuickReg", "SaveData", conn);
                Services.DumException("SaveData^^" + facilityName + " ##MES#008", "QuickReg ", request, ex);
                Parsehtm Parser = new Parsehtm(request);
                Parser.SetField("FormName", "QuickReg");
                Parser.SetField("ActionID", "GetValues&ClientIndex=" + ClientIndex + "");
            ...
            try {
                ...
                helper.SendEmailWithAttachment("Error in QuickReg ** (SaveData Insertion EmergencyInfo^^" + facilityName + " ##MES#009)", servletContext, ex, "QuickReg", "SaveData", conn);
                Services.DumException("SaveData^^" + facilityName + " ##MES#009", "QuickReg ", request, ex);
                Parsehtm Parser = new Parsehtm(request);
                Parser.SetField("FormName", "QuickReg");
                Parser.SetField("ActionID", "GetValues&ClientIndex=" + ClientIndex + "");
            ...
            try {
                ...
                helper.SendEmailWithAttachment("Error in QuickReg ** (SaveData Insertion RandomCheckInfo^^" + facilityName + " ##MES#010)", servletContext, ex, "QuickReg", "SaveData", conn);
                Services.DumException("SaveData^^" + facilityName + " ##MES#010", "QuickReg ", request, ex);
                Parsehtm Parser = new Parsehtm(request);
                Parser.SetField("FormName", "QuickReg");
                Parser.SetField("ActionID", "GetValues&ClientIndex=" + ClientIndex + "");
            ...
            helper.SendEmailWithAttachment("Error in QuickReg ** (SaveData Main Catch^^" + facilityName + " ##MES#011)", servletContext, ex, "QuickReg", "SaveData", conn);
            Services.DumException("SaveData^^" + facilityName + " ##MES#011", "QuickReg ", request, ex);
            Parsehtm Parser = new Parsehtm(request);
            Parser.SetField("FormName", "QuickReg");
            Parser.SetField("ActionID", "GetValues&ClientIndex=" + ClientIndex + "");
    ...
    void Victoria_2(final HttpServletRequest request, final PrintWriter out, final Connection conn, final ServletContext servletContext, final String UserId, final HttpServletResponse response, final String Database, String FontColor, UtilityHelper helper) throws FileNotFoundException {
        final int ClientIndex = Integer.parseInt(request.getParameter("ClientIndex").trim());
        String facilityName = helper.getFacilityName(request, conn, servletContext, ClientIndex);
        try {
            Statement stmt = null;
            ...
            try {
                ...
                helper.SendEmailWithAttachment("Error in QuickReg ** (SaveData^^" + facilityName + " ##MES#0012)", servletContext, ex, "QuickReg", "SaveData", conn);
                Services.DumException("SaveData^^" + facilityName + " ##MES#0012", "QuickReg ", request, ex);
                Parsehtm Parser = new Parsehtm(request);
                Parser.SetField("FormName", "QuickReg");
                Parser.SetField("ActionID", "GetValues&ClientIndex=" + ClientIndex + "");
                Parser.SetField("Message", "MES#0012");
                Parser.GenerateHtml(out, Services.GetHtmlPath(servletContext) + "Exception/ExceptionMessage.html");
                return;
            }
            try {
                ...
                UtilityHelper utilityHelper = new UtilityHelper();
                String ClientIp = utilityHelper.getClientIp(request);
                PreparedStatement MainReceipt = conn.prepareStatement(" INSERT INTO " + Database + ".PatientReg (ClientIndex,FirstName,LastName ,"
                        + " MiddleInitial,DOB,Age,Gender ,Email,PhNumber ,Address,City ,State,Country,ZipCode,SSN,Occupation ,Employer ,EmpContact,"
                        + " PriCarePhy,ReasonVisit,SelfPayChk,CreatedDate,Title, MaritalStatus,CreatedBy, MRN, Status, " +
                        "ExtendedMRN, County, DoctorsName,ViewDate,RegisterFrom,EnterBy,EnterIP) \n"
                        + " VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,now(),?,?,?,?,0,?,?,?,NOW(),?,?,?) ");
                MainReceipt.setInt(1, ClientIndex);
                MainReceipt.setString(2, FirstName);
                MainReceipt.setString(3, LastName);
                ...
                MainReceipt.setString(29, "Quick Reg Form V");
                MainReceipt.setString(30, UserId);
                MainReceipt.setString(31, ClientIp);
                MainReceipt.executeUpdate();
                MainReceipt.close();
            } catch (Exception ex) {
                helper.SendEmailWithAttachment("Error in QuickReg ** (SaveData Insertion PatientReg^^" + facilityName + " ##MES#013)", servletContext, ex, "QuickReg", "SaveData", conn);
                Services.DumException("SaveData^^" + facilityName + " ##MES#013", "QuickReg ", request, ex);
                Parsehtm Parser = new Parsehtm(request);
                Parser.SetField("FormName", "QuickReg");
                Parser.SetField("ActionID", "GetValues&ClientIndex=" + ClientIndex + "");
            ...
            try {
                ...
                helper.SendEmailWithAttachment("Error in QuickReg ** (SaveData Insertion PatientVisit^^" + facilityName + " ##MES#014)", servletContext, ex, "QuickReg", "SaveData", conn);
                Services.DumException("SaveData^^" + facilityName + " ##MES#014", "QuickReg ", request, ex);
                Parsehtm Parser = new Parsehtm(request);
                Parser.SetField("FormName", "QuickReg");
                Parser.SetField("ActionID", "GetValues&ClientIndex=" + ClientIndex + "");
            ...
            try {
                final PreparedStatement MainReceipt = conn.prepareStatement(
                        "INSERT INTO " + Database + ".PatientReg_Details (PatientRegId,Ethnicity,Race,EmployementChk,Employer,Occupation," +
                ...
                // System.out.println("QUICK REQ ... PAT REg DET --> " + MainReceipt.toString());
                MainReceipt.executeUpdate();
                MainReceipt.close();
            } catch (Exception ex) {
                helper.SendEmailWithAttachment("Error in QuickReg ** (SaveData Insertion PatientReg_Details^^" + facilityName + " ##MES#015)", servletContext, ex, "QuickReg", "SaveData", conn);
                Services.DumException("SaveData^^" + facilityName + " ##MES#015", "QuickReg ", request, ex);
                Parsehtm Parser = new Parsehtm(request);
                Parser.SetField("FormName", "QuickReg");
                Parser.SetField("ActionID", "GetValues&ClientIndex=" + ClientIndex + "");
            ...
            if (WorkersCompPolicyChk.equals("1")) {
                try {
                    final PreparedStatement MainReceipt = conn.prepareStatement(
                            " INSERT INTO " + Database + ".Patient_WorkCompPolicy (PatientRegId,WCPDateofInjury," +
                    ...
                    helper.SendEmailWithAttachment("Error in QuickReg ** (SaveData Insertion Patient_WorkCompPolicy^^" + facilityName + " ##MES#016)", servletContext, ex, "QuickReg", "SaveData", conn);
                    Services.DumException("SaveData^^" + facilityName + " ##MES#016", "QuickReg ", request, ex);
                    Parsehtm Parser = new Parsehtm(request);
                    Parser.SetField("FormName", "QuickReg");
                    Parser.SetField("ActionID", "GetValues&ClientIndex=" + ClientIndex + "");
            ...
            if (MotorVehicleAccidentChk.equals("1")) {
                try {
                    final PreparedStatement MainReceipt = conn.prepareStatement(
                            "INSERT INTO " + Database + ".Patient_AutoInsuranceInfo (PatientRegId," +
                    ...
                    helper.SendEmailWithAttachment("Error in QuickReg ** (SaveData Insertion Patient_AutoInsuranceInfo^^" + facilityName + " ##MES#017)", servletContext, ex, "QuickReg", "SaveData", conn);
                    Services.DumException("SaveData^^" + facilityName + " ##MES#017", "QuickReg ", request, ex);
                    Parsehtm Parser = new Parsehtm(request);
                    Parser.SetField("FormName", "QuickReg");
                    Parser.SetField("ActionID", "GetValues&ClientIndex=" + ClientIndex + "");
            ...
            if (HealthInsuranceChk.equals("1")) {
                try {
                    final PreparedStatement MainReceipt = conn.prepareStatement(
                            "INSERT INTO " + Database + ".Patient_HealthInsuranceInfo (PatientRegId," +
                    ...
                    helper.SendEmailWithAttachment("Error in QuickReg ** (SaveData Insertion Patient_HealthInsuranceInfo^^" + facilityName + " ##MES#018)", servletContext, ex, "QuickReg", "SaveData", conn);
                    Services.DumException("SaveData^^" + facilityName + " ##MES#018", "QuickReg ", request, ex);
                    Parsehtm Parser = new Parsehtm(request);
                    Parser.SetField("FormName", "QuickReg");
                    Parser.SetField("ActionID", "GetValues&ClientIndex=" + ClientIndex + "");
            ...
            try {
                ...
                helper.SendEmailWithAttachment("Error in QuickReg ** (SaveData Insertion MarketingInfo^^" + facilityName + " ##MES#019)", servletContext, ex, "QuickReg", "SaveData", conn);
                Services.DumException("SaveData^^" + facilityName + " ##MES#019", "QuickReg ", request, ex);
                Parsehtm Parser = new Parsehtm(request);
                Parser.SetField("FormName", "QuickReg");
                Parser.SetField("ActionID", "GetValues&ClientIndex=" + ClientIndex + "");
            ...
            helper.SendEmailWithAttachment("Error in QuickReg ** (SaveData Insertion Main Catch^^" + facilityName + " ##MES#020)", servletContext, ex, "QuickReg", "SaveData", conn);
            Services.DumException("SaveData^^" + facilityName + " ##MES#020", "QuickReg ", request, ex);
            Parsehtm Parser = new Parsehtm(request);
            Parser.SetField("FormName", "QuickReg");
            Parser.SetField("ActionID", "GetValues&ClientIndex=" + ClientIndex + "");
