...
public class finaltrizettoTab {
    ...
    public static void callSoapWebService(String soapEndpointUrl, String soapAction, String GediPayerID, String NPI, String FirstName, String LastName, String InsuranceNum, String DOB, String Gender, String GPN, String PatientId, String UserId, String proname) {
        try {
            ...
            try {
                ...
                System.out.println("Error 2 - Insertion Final Trizetto Table :" + e.getMessage());
                return;
            }
    ...
    public static Connection getMysqlConn() {
        try {
            ...
            return DriverManager.getConnection("jdbc:mysql://database-1.cvsodt2nhyzz.us-east-1.rds.amazonaws.com/oe_2?user=rovermdadmin&password=atyu!ioujy1986");
        } catch (Exception ex) {
        }
        return null;
    }
