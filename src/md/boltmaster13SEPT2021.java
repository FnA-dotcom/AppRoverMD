...
public class boltmaster13SEPT2021 {
...
//		System.out.println(AuthCardRe);
    ...
    public String validateConnection() {
        String Message = "";
        System.out.println("IN VALIDATE FUNCT");
        System.out.println("Session Key " + this.sessionKey);
        this.sessionKey = null;
//  System.out.println("Session Key After null"+ sessionKey);
...
//                boolean ok = ping();
                ...
                // boolean ok = true;
                if (ok) {
                    System.out.println("Inside Session Key ping OK");
                    ...
                    System.out.println("Inside Session Key ping NOT OK");
                    this.terminalConnected = false;
                    this.sessionKey = null;
                    this.sessionKey = validateConnection();
                }
            } catch (IOException e) {
