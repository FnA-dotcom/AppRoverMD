...
public class PatientVisit13MARCH2021 extends HttpServlet {
        ...
        try {
            ...
            switch (ActionID) {
                case "SearchPatient":
                    ...
                    this.SearchPatient(request, out, conn, context, UserId, DatabaseName, FacilityIndex);
                    break;
                case "GetData":
                    ...
                    this.GetData(request, out, conn, context, UserId, DatabaseName, FacilityIndex);
                    break;
                case "AddNewVisit":
                    ...
                    this.AddNewVisit(request, out, conn, context, UserId, DatabaseName, FacilityIndex);
                    break;
                case "SaveVisit":
                    ...
                    this.SaveVisit(request, out, conn, context, UserId, DatabaseName, FacilityIndex);
                    break;
                default:
...
//      out.println(Query);
            while (rset.next()) {
                Query2 = " Select CONCAT(IFNULL(b.Title,''),' ',b.FirstName,' ',b.MiddleInitial,' ',b.LastName), DATE_FORMAT(b.DOB,'%m/%d/%Y'), b.PhNumber, a.ReasonVisit, IFNULL(DATE_FORMAT(a.DateofService,'%m/%d/%Y %T'),DATE_FORMAT(b.CreatedDate,'%m/%d/%Y %T'))," +
                        ...
                        " WHEN b.COVIDStatus = -1 THEN 'SUSPECTED' ELSE 'UN-EXAMINED' END , a.MRN, b.Status" +
                        " from " + Database + ".PatientVisit a " +
                        " Left Join " + Database + ".PatientReg b on a.PatientRegId = b.Id where b.ID =  " + rset.getInt(1) + " order by a.DateofService desc";
...
//        System.out.println(Query2);
                while (rset2.next()) {
                    ...
                    if (rset2.getInt(8) == 1) {
                        CDRList.append("<td align=left disabled><a href=/md/md.PatientVisit?ActionID=AddNewVisit&ID=" + rset.getInt(1) + ">Add New Visit</a></td>\n");
                    } else {
                        CDRList.append("<td align=left><a href=/md/md.PatientVisit?ActionID=AddNewVisit&ID=" + rset.getInt(1) + ">Add New Visit</a></td>\n");
                    }

                    CDRList.append("<td align=left><button type=\"button\" class=\"waves-effect waves-light btn btn-outline btn-rounded btn-info mb-5\" onclick=\"UpdateInfoPatient(" + rset.getInt(1) + "," + rset2.getInt(8) + ")\">Update</button></td>\n");

//          CDRList.append("<td align=left><a href=/md/md.PrintLabel4?ActionID=GETINPUT&ID="+rset.getInt(1)+">Print Label</a></td>\n");
//          if(ClientId == 8) {
//            CDRList.append("<td align=left><a href=/md/md.DownloadBundle?ActionID=GETINPUT&ID=" + rset.getInt(1) + ">Downlaod Admission Bundle</a></td>\n");
//          }else if(ClientId == 9){
//            CDRList.append("<td align=left><a href=/md/md.DownloadBundle?ActionID=GETINPUTVictoria&ID=" + rset.getInt(1) + ">Downlaod Admission Bundle</a></td>\n");
//          }else if (ClientId == 10){
//            CDRList.append("<td align=left><a href=/md/md.DownloadBundle?ActionID=GETINPUTOddasa&ID=" + rset.getInt(1) + ">Downlaod Admission Bundle</a></td>\n");
//          }else if(ClientId == 12) {
//        	  CDRList.append("<td align=left><a href=/md/md.DownloadBundle?ActionID=GETINPUTSAustin&ID=" + rset.getInt(1) + ">Downlaod Admission Bundle</a></td>\n");
//          }else if(ClientId == 15) {
//        	  CDRList.append("<td align=left><a href=/md/md.DownloadBundle?ActionID=GETINPUTSublime&ID=" + rset.getInt(1) + ">Downlaod Admission Bundle</a></td>\n");
//          }
...
//          CDRList.append("<td align=left><a href=/md/md.PatientInfo?ActionID=GetValues&ID=" + rset.getInt(1) + ">Send to E-Doc</a></td>\n");
                    CDRList.append("<td align=left><button type=\"button\" class=\"waves-effect waves-light btn btn-outline btn-rounded btn-warning mb-5\" onclick=\"ReactivePatient(" + rset.getInt(1) + "," + rset2.getInt(8) + ")\">Reactive</button></td>\n");
