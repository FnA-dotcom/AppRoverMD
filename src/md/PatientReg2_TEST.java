...
public class PatientReg2_TEST extends HttpServlet {
    ...
    void Victoria_2(final HttpServletRequest request, final PrintWriter out, final Connection conn, final ServletContext servletContext) {
        try {
            ...
            if (ClientIndex == 9) {
                Parser.GenerateHtml(out, String.valueOf(String.valueOf(Services.GetHtmlPath(this.getServletContext()))) + "Forms/PatientRegFormVictoria_2_TEST.html");
