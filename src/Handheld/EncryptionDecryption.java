...
//            String DEC = EncryptionDecryption.decrypt("dxAwprj1yuipUg8mGlaMSw==");
            String DEC = EncryptionDecryption.decrypt("aO7wkrjTjOZ+f65FWSPlCw==a");
...
//            String Enc = EncryptionDecryption.encrypt("Patient^Testing A^Houston^TX^77090^^17154 Butte Creek Rd^11.68^4444333322221111^0822^314");
//            System.out.println("Encrypted Val ---- " + Enc);
//            String DEC = EncryptionDecryption.decrypt(Enc);
//            String[] splitValues = decrypt(Enc).split("\\^");
//            String Message = splitValues[0];
//            String DEC = EncryptionDecryption.decrypt("uy/C+kpkZXce7a4xqEIjNJ8WQAEcdgTGCLzMHHOTJCTQWWMxijt4IBb5PV2a/KCHj6QE5bdo2JVL ICLKy5g5yCl/poD7dnq4wUKAgsi8xadNYBT/3R1U9H7JuiNsZ6Zy");
//            System.out.println("Decrypted Val ---- " + Message);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
